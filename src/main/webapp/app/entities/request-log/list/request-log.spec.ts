...
describe('RequestLog Management Component', () => {
  let httpMock: HttpTestingController;
  let comp: RequestLog;
  let fixture: ComponentFixture<RequestLog>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(RequestLog);
  ...
  it('should not fail on resource error state', async () => {
    ...
    expect(comp.requestLogs()).toEqual([]);
  ...
  it('should calculate the sort attribute for an id', () => {
    ...
    // THEN
    expect(service.requestLogsParams()).toMatchObject(expect.objectContaining({ sort: ['id,desc'] }));
  });
  ...
  it('should calculate the filter attribute', () => {
    ...
    // THEN
    expect(service.requestLogsParams()).toMatchObject(expect.objectContaining({ 'someId.in': ['dc4279ea-cfb9-11ec-9d64-0242ac120002'] }));
  });
});
