...
function $(r, e = !1, t = 0) {
  ...
  if (h !== void 0 && h.size !== 0)
    if (e)
      if (Array.isArray(s)) for (let n = t; n < s.length; n++) (i(s[n], !1), o(s[n]));
...
class y extends p {
  constructor(e) {
    if ((super(e), e.type !== a.ELEMENT)) throw new Error(`\`${this.constructor.name}\` must be bound to an element.`);
  ...
  /** @override */
  update(e, [t, s]) {
    return this.hasChanged(s)
      ? ((this.host = e.options && e.options.host),
        (this.element = e.element),
        (this.renderer = t),
        this.previousValue === u ? this.addRenderer() : this.runRenderer(),
        (this.previousValue = Array.isArray(s) ? [...s] : s),
        d)
      : d;
  }
  /** @override */
  ...
  hasChanged(e) {
    return Array.isArray(e)
      ? !Array.isArray(this.previousValue) || this.previousValue.length !== e.length
        ? !0
        : e.some((t, s) => t !== this.previousValue[s])
