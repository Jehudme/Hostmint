...
export declare function _getIcon(
  node: FigmaNode,
  enablerKey: string,
  iconKey: string,
  slot?: string | undefined,
): ComponentDefinition | undefined;
export declare function renderNodesAs(
  htmlTag: string,
  nodes: Array<FigmaNode | undefined>,
  metadata: ImportMetadata,
): ComponentDefinition[];
export declare function renderNodeAs(
  htmlTag: string,
  node: FigmaNode,
  metadata: ImportMetadata,
...
export declare function renderNode(
  node: FigmaNode,
  metadata: ImportMetadata,
  customProperties?: Record<string, string>,
): ComponentDefinition | undefined;
...
export declare function createChildrenDefinitions(
  node: FigmaNode,
  metadata: ImportMetadata,
  matcher: (n: FigmaNode) => boolean,
): ComponentDefinition[];
export {};
