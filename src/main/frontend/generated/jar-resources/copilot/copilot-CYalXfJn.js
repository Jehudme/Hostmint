class Hi {
  ...
  getEventTarget() {
    return this.copilotMain
      ? this.copilotMain
      : ((this.copilotMain = document.querySelector('copilot-main')),
        this.copilotMain ? (this.eventProxy.processQueue(this.copilotMain), this.copilotMain) : this.eventProxy);
  }
  ...
  emit(e, r) {
    ...
    return (
      this.handledTypes.includes(e) || this.eventBuffer.push(o),
      this.debug && console.debug('Emit event', o),
...
var Gr = {};
Object.freeze(Gr);
var Bi = typeof Proxy < 'u',
  Yi = /* @__PURE__ */ Object.toString();
function Sa() {
  Bi ||
    h(
...
function st(t) {
  process.env.NODE_ENV !== 'production' &&
    p.verifyProxies &&
    h("MobX is currently configured to be able to run in ES5 mode, but in ES5 MobX won't be able to " + t);
}
function X() {
  return ++p.mobxGuid;
}
...
function ee(t) {
  function e(r, o) {
    if (Ot(o)) return t.decorate_20223_(r, o);
    Et(r, o, t);
  }
...
function an(t, e, r) {
  if (process.env.NODE_ENV !== 'production' && !Ht(e) && J(t[ne], r)) {
    var o = t.constructor.name + '.prototype.' + r.toString(),
      a = t[ne][r].annotationType_,
      i = e.annotationType_;
    h(
      "Cannot apply '@" +
        i +
...
function dr(t, e) {
  process.env.NODE_ENV !== 'production' &&
    !e.includes(t.kind) &&
    h("The decorator applied to '" + String(t.name) + "' cannot be used on a " + t.kind + ' element');
}
var g = /* @__PURE__ */ Symbol('mobx administration'),
  fe = /* @__PURE__ */ (function () {
    function t(r) {
      (r === void 0 && (r = process.env.NODE_ENV !== 'production' ? 'Atom@' + X() : 'Atom'),
        (this.name_ = void 0),
        (this.flags_ = 0),
...
function ln(t, e, r) {
  if (t == null || rt(t) || br(t) || ge(t) || Y(t)) return t;
  if (Array.isArray(t))
    return k.array(t, {
      name: r,
      deep: !1,
  ...
  process.env.NODE_ENV !== 'production' &&
    h('The shallow modifier / decorator can only used in combination with arrays, objects, maps and sets');
}
function pr(t) {
  return t;
}
function cn(t, e) {
  return (
    process.env.NODE_ENV !== 'production' && yt(t) && h('observable.struct should not be used with observable values'),
    di(t, e) ? e : t
  );
}
var dn = 'override';
...
function pn(t, e, r, o) {
  var a;
  if ((a = this.options_) != null && a.bound) return this.extend_(t, e, r, !1) === null ? 0 : 1;
  if (o === t.target_) return this.extend_(t, e, r, !1) === null ? 0 : 2;
  if (Te(r.value)) return 1;
...
function hn(t, e) {
  ...
  var r = e.kind,
    ...
    n = function (c) {
      var d, u, v, b;
      return Ce(
        (d = (u = i.options_) == null ? void 0 : u.name) != null ? d : o.toString(),
        c,
        (v = (b = i.options_) == null ? void 0 : b.autoAction) != null ? v : !1,
      );
    };
  if (r == 'field')
    return function (l) {
...
function fn(t, e, r, o) {
  var a;
  if (o === t.target_) return this.extend_(t, e, r, !1) === null ? 0 : 2;
  if ((a = this.options_) != null && a.bound && (!J(t.target_, e) || !mt(t.target_[e])) && this.extend_(t, e, r, !1) === null) return 0;
  if (mt(r.value)) return 1;
  var i = Ta(t, this, e, r, !1, !1);
  return ($(o, e, i), 2);
}
function gn(t, e, r, o) {
  var a,
    i = Ta(t, this, e, r, (a = this.options_) == null ? void 0 : a.bound);
...
function xn(t, e) {
  ...
  return (
    a(function () {
      ...
      (n.name || (n.name = process.env.NODE_ENV !== 'production' ? i.name_ + '.' + o.toString() : 'ObservableObject.' + o.toString()),
        i.values_.set(o, new F(n)));
    }),
    function () {
...
function En(t, e, r, o) {
  ...
  return (
    An(t, this, e, r),
    t.defineObservableProperty_(e, r.value, (a = (i = this.options_) == null ? void 0 : i.enhancer) != null ? a : Ve, o)
  );
}
function On(t, e) {
  if (process.env.NODE_ENV !== 'production') {
  ...
  function n(s, l) {
    var c,
      ...
      v = new Ae(
        l,
        (c = (d = r.options_) == null ? void 0 : d.enhancer) != null ? c : Ve,
        process.env.NODE_ENV !== 'production' ? u.name_ + '.' + a.toString() : 'ObservableObject.' + a.toString(),
        !1,
      );
...
function Cn(t, e, r, o) {
  var a, i;
  if (r.get) return hr.make_(t, e, r, o);
  if (r.set) {
  ...
  if (o !== t.target_ && typeof r.value == 'function') {
    ...
    if (ka(r.value)) {
      var l,
        c = (l = this.options_) != null && l.autoBind ? Ge.bound : Ge;
...
function Nn(t, e, r, o) {
  var a, i;
  if (r.get) return hr.extend_(t, e, r, o);
  if (r.set)
...
var Dn = 'observable',
  zn = 'observable.ref',
  In = 'observable.shallow',
  Rn = 'observable.struct',
  za = {
    deep: !0,
    name: void 0,
...
function Ra(t, e, r) {
  if (Ot(e)) return Mr.decorate_20223_(t, e);
  if (Pe(e)) {
    Et(t, e, Mr);
    return;
  }
...
var jn = {
  ...
  hr = function (e, r) {
    if (Ot(r)) return Ur.decorate_20223_(e, r);
    if (Pe(r)) return Et(e, r, Ur);
    if (C(e)) return ee(eo(qa, e));
    process.env.NODE_ENV !== 'production' &&
      (E(e) || h('First argument to `computed` should be an expression.'),
      E(r) && h('A setter as second argument is no longer supported, use `{ set: fn }` option instead'));
    var o = C(r) ? r : {};
...
var wo,
  ...
  Jt = 0,
  Xn = 1,
  Hn = (wo = (xo = /* @__PURE__ */ Ft(function () {}, 'name')) == null ? void 0 : xo.configurable) != null ? wo : !1,
  So = {
    value: 'action',
    configurable: !0,
    writable: !1,
...
function Ce(t, e, r, o) {
  (r === void 0 && (r = !1),
    process.env.NODE_ENV !== 'production' &&
      (E(e) || h('`action` can only be invoked on functions'),
      (typeof t != 'string' || !t) && h("actions should have valid names, got: '" + t + "'")));
  function a() {
...
function Jn(t, e, r, o) {
  var a = process.env.NODE_ENV !== 'production' && P() && !!t,
    i = 0;
...
function Kn(t) {
  (Jt !== t.actionId_ && h(30),
    (Jt = t.parentActionId_),
    t.error_ !== void 0 && (p.suppressReactionErrors = !0),
    fr(t.prevAllowStateChanges_),
    ht(t.prevAllowStateReads_),
    j(),
    t.runAsAction_ && le(t.prevDerivation_),
    process.env.NODE_ENV !== 'production' &&
      t.notifySpy_ &&
      q({
...
var Bn = 'create',
  Ae = /* @__PURE__ */ (function (t) {
    function e(o, a, i, n, s) {
      var l;
      if (
        (i === void 0 && (i = process.env.NODE_ENV !== 'production' ? 'ObservableValue@' + X() : 'ObservableValue'),
        n === void 0 && (n = !0),
        s === void 0 && (s = Ye.default),
        (l = t.call(this, i) || this),
        (l.enhancer = void 0),
        (l.name_ = void 0),
        (l.equals = void 0),
      ...
      (r.set = function (a) {
        ...
        if (((a = this.prepareNewValue_(a)), a !== p.UNCHANGED)) {
          ...
          (process.env.NODE_ENV !== 'production' &&
            ...
            this.setNewValue_(a),
            process.env.NODE_ENV !== 'production' && n && q());
        }
      }),
  ...
  F = /* @__PURE__ */ (function () {
    function t(r) {
      ((this.dependenciesState_ = m.NOT_TRACKING_),
        ...
        (this.name_ = r.name || (process.env.NODE_ENV !== 'production' ? 'ComputedValue@' + X() : 'ComputedValue')),
        r.set && (this.setter_ = Ce(process.env.NODE_ENV !== 'production' ? this.name_ + '-setter' : 'ComputedValue-setter', r.set)),
        (this.equals_ = r.equals || (r.compareStructural || r.struct ? Ye.structural : Ye.default)),
    ...
    return (
      ...
      (e.get = function () {
        if (
          ...
          p.inBatch === 0 && // !globalState.trackingDerivatpion &&
      ...
      (e.trackAndCompute = function () {
        var o = this.value_,
          ...
          n = a || Zt(o) || Zt(i) || !this.equals_(o, i);
        return (
          n &&
            ((this.value_ = i),
            process.env.NODE_ENV !== 'production' &&
      ...
      (e.computeValue_ = function (o) {
        ...
        var a = vr(!1),
          i;
        if (o) i = Ma(this, this.derivation, this.scope_);
      ...
      (e.warnAboutUntrackedRead_ = function () {
        process.env.NODE_ENV !== 'production' &&
          ...
          (typeof this.requiresReaction_ == 'boolean' ? this.requiresReaction_ : p.computedRequiresReaction) &&
...
F.diffValueMask_ = 16;
var gr = /* @__PURE__ */ Le('ComputedValue', F),
  m;
(function (t) {
  ...
  switch (t.dependenciesState_) {
    ...
    case m.POSSIBLY_STALE_: {
      for (var e = to(!0), r = Me(), o = t.observing_, a = o.length, i = 0; i < a; i++) {
        var n = o[i];
        if (gr(n)) {
          if (p.disableErrorBoundaries) n.get();
          else
            try {
              n.get();
            } catch {
          ...
          if (t.dependenciesState_ === m.STALE_) return (le(r), ht(e), !0);
        }
      }
...
function Yn(t) {
  process.env.NODE_ENV !== 'production' &&
    !p.allowStateReads &&
    p.observableRequiresReaction &&
    console.warn("[mobx] Observable '" + t.name_ + "' being read outside a reactive context.");
}
function Ma(t, e, r) {
  var o = to(!0);
  (Za(t),
  ...
  var i;
  if (p.disableErrorBoundaries === !0) i = e.call(r);
  else
    try {
      i = e.call(r);
    } catch (n) {
...
function Gn(t) {
  process.env.NODE_ENV !== 'production' &&
    ...
    (typeof t.requiresObservable_ == 'boolean' ? t.requiresObservable_ : p.reactionRequiresObservable) &&
    console.warn("[mobx] Derivation '" + t.name_ + "' is created/updated without reading any observable value.");
}
function _n(t) {
...
function Za(t) {
  if (t.dependenciesState_ !== m.UP_TO_DATE_) {
    ...
    for (var e = t.observing_, r = e.length; r--; ) e[r].lowestObserverState_ = m.UP_TO_DATE_;
  }
}
var Er = function () {
    ((this.version = 6),
  ...
  p = /* @__PURE__ */ (function () {
    var t = /* @__PURE__ */ Yr();
    return (
      t.__mobxInstanceCount > 0 && !t.__mobxGlobals && (Or = !1),
      t.__mobxGlobals && t.__mobxGlobals.version !== new Er().version && (Or = !1),
      Or
        ? t.__mobxGlobals
          ? ((t.__mobxInstanceCount += 1), t.__mobxGlobals.UNCHANGED || (t.__mobxGlobals.UNCHANGED = {}), t.__mobxGlobals)
          : ((t.__mobxInstanceCount = 1), (t.__mobxGlobals = /* @__PURE__ */ new Er()))
        : (setTimeout(function () {
            h(35);
          }, 1),
          new Er())
  ...
  if (--p.inBatch === 0) {
    ...
    for (var t = p.pendingUnobservations, e = 0; e < t.length; e++) {
      ...
      ((r.isPendingUnobservation = !1),
        r.observers_.size === 0 && (r.isBeingObserved && ((r.isBeingObserved = !1), r.onBUO()), r instanceof F && r.suspend_()));
    }
...
function Fa(t) {
  ...
  return e !== null
    ? (e.runId_ !== t.lastAccessedBy_ &&
        ...
        !t.isBeingObserved && p.trackingContext && ((t.isBeingObserved = !0), t.onBO())),
      t.isBeingObserved)
    : (t.observers_.size === 0 && p.inBatch > 0 && Wa(t), !1);
}
function Xa(t) {
  t.lowestObserverState_ !== m.STALE_ &&
    ((t.lowestObserverState_ = m.STALE_),
    t.observers_.forEach(function (e) {
      (e.dependenciesState_ === m.UP_TO_DATE_ &&
        (process.env.NODE_ENV !== 'production' && e.isTracing_ !== W.NONE && Ha(e, t), e.onBecomeStale_()),
        (e.dependenciesState_ = m.STALE_));
    }));
}
function es(t) {
  t.lowestObserverState_ !== m.STALE_ &&
    ((t.lowestObserverState_ = m.STALE_),
    t.observers_.forEach(function (e) {
      e.dependenciesState_ === m.POSSIBLY_STALE_
        ? ((e.dependenciesState_ = m.STALE_), process.env.NODE_ENV !== 'production' && e.isTracing_ !== W.NONE && Ha(e, t))
        : e.dependenciesState_ === m.UP_TO_DATE_ && (t.lowestObserverState_ = m.UP_TO_DATE_);
    }));
}
function ts(t) {
  t.lowestObserverState_ === m.UP_TO_DATE_ &&
    ((t.lowestObserverState_ = m.POSSIBLY_STALE_),
    t.observers_.forEach(function (e) {
...
function Ja(t, e, r) {
  ...
  (e.push('' + '	'.repeat(r - 1) + t.name),
    t.dependencies &&
      t.dependencies.forEach(function (o) {
        return Ja(o, e, r + 1);
      }));
}
var te = /* @__PURE__ */ (function () {
  ...
  return (
    ...
    (e.track = function (o) {
      if (!this.isDisposed) {
        ...
        ((p.trackingContext = n),
          ...
          Zt(s) && this.reportExceptionInDerivation_(s.cause),
          process.env.NODE_ENV !== 'production' &&
            a &&
            q({
              time: Date.now() - i,
    ...
    (e.reportExceptionInDerivation_ = function (o) {
      ...
      if (p.disableErrorBoundaries) throw o;
      var i =
        process.env.NODE_ENV !== 'production'
    ...
    (e.getDisposer_ = function (o) {
      ...
      return (
        o == null || o.addEventListener == null || o.addEventListener('abort', i),
        (i[g] = this),
...
function rs(t) {
  return (
    p.globalReactionErrorHandlers.push(t),
    function () {
      ...
      (console.error(
        process.env.NODE_ENV !== 'production'
          ? "Reaction doesn't converge to a stable state after " +
              ko +
              ' iterations.' +
              (' Probably there is a cycle in the reactive function: ' + t[0])
          : '[mobx] cycle in reaction: ' + t[0],
      ),
      t.splice(0));
    for (var r = t.splice(0), o = 0, a = r.length; o < a; o++) r[o].runReaction_();
  }
...
function Ne(t) {
  if (process.env.NODE_ENV !== 'production' && p.spyListeners.length) for (var e = p.spyListeners, r = 0, o = e.length; r < o; r++) e[r](t);
}
function R(t) {
  if (process.env.NODE_ENV !== 'production') {
    var e = ve({}, t, {
...
function Ya(t) {
  var e = function (o, a) {
    if (E(o)) return Ce(o.name || Ba, o, t);
    if (E(a)) return Ce(o, a, t);
    if (Ot(a)) return (t ? Fr : Wr).decorate_20223_(o, a);
    if (Pe(a)) return Et(o, a, t ? Fr : Wr);
    if (Pe(o))
      return ee(
        At(t ? Qa : ro, {
          name: o,
...
function Ga(t, e) {
  ...
  (e === void 0 && (e = Gr),
    process.env.NODE_ENV !== 'production' &&
      (E(t) || h('Autorun expects a function as first argument'),
      Te(t) && h('Autorun does not accept actions since actions are untrackable')));
  var n =
      (r = (o = e) == null ? void 0 : o.name) != null ? r : process.env.NODE_ENV !== 'production' ? t.name || 'Autorun@' + X() : 'Autorun',
    s = !e.scheduler && !e.delay,
    l;
  if (s)
    l = new te(
      n,
...
function oo(t, e, r) {
  ...
  (r === void 0 && (r = Gr),
    process.env.NODE_ENV !== 'production' &&
      ((!E(t) || !E(e)) && h('First and second argument to reaction should be functions'),
      C(r) || h('Third argument of reactions should be an object')));
  var n = (o = r.name) != null ? o : process.env.NODE_ENV !== 'production' ? 'Reaction@' + X() : 'Reaction',
    s = Se(n, r.onError ? us(r.onError, e) : e),
    l = !r.scheduler && !r.delay,
    c = _a(r),
    d = !0,
    u = !1,
    v,
    b = r.compareStructural ? Ye.structural : r.equals || Ye.default,
    w = new te(
      n,
      function () {
        d || l ? N() : u || ((u = !0), c(N));
  ...
  function N() {
    if (((u = !1), !w.isDisposed)) {
      ...
      (w.track(function () {
        ...
        ((d && r.fireImmediately) || (!d && T)) && s(v, me, w),
        (d = !1));
    }
  }
...
function ei(t, e, r, o) {
  var a = De(e),
    ...
    n = t + 'L';
  return (
    a[n] ? a[n].add(i) : (a[n] = /* @__PURE__ */ new Set([i])),
    function () {
      var s = a[n];
...
function ti(t, e, r, o) {
  process.env.NODE_ENV !== 'production' &&
    (arguments.length > 4 && h("'extendObservable' expected 2-4 arguments"),
    typeof t != 'object' && h("'extendObservable' expects an object as first argument"),
    ge(t) && h("'extendObservable' should not be used on maps, use map.merge instead"),
    C(e) || h("'extendObservable' only accepts plain objects as second argument"),
    (yt(e) || yt(r)) && h('Extending an object with another observable (object) is not supported'));
  var a = $i(e);
  return (
    Ue(function () {
      var i = tt(t, o)[g];
...
var Ar = /* @__PURE__ */ Na('flow'),
  ys = /* @__PURE__ */ Na('flow.bound', {
    bound: !0,
  }),
  Ge = /* @__PURE__ */ Object.assign(function (e, r) {
    if (Ot(r)) return Ar.decorate_20223_(e, r);
    if (Pe(r)) return Et(e, r, Ar);
    ...
    var o = e,
      ...
      i = function () {
        var s = this,
          l = arguments,
          c = ++ms,
          d = Se(a + ' - runid: ' + c + ' - init', o).apply(s, l),
          u,
          v = void 0,
          b = new Promise(function (w, N) {
            var T = 0;
            u = N;
            function me(D) {
              v = void 0;
        ...
        return (
          (b.cancel = Se(a + ' - runid: ' + c + ' - cancel', function () {
            try {
              v && Eo(v);
              var w = d.return(void 0),
                N = Promise.resolve(w.value);
...
function yt(t) {
  return (
    process.env.NODE_ENV !== 'production' &&
      arguments.length !== 1 &&
      h('isObservable expects only 1 argument. Use isObservableProp to inspect the observability of a property'),
    ws(t)
  );
}
function Vd(t, e, r, o) {
...
function ks() {
  if (process.env.NODE_ENV !== 'production') {
    for (var t = !1, e = arguments.length, r = new Array(e), o = 0; o < e; o++) r[o] = arguments[o];
...
var Os = {
  has: function (e, r) {
    return (
      process.env.NODE_ENV !== 'production' &&
        p.trackingDerivation &&
        st("detect new properties using the 'in' operator. Use 'has' from 'mobx' instead."),
      we(e).has_(r)
    );
  },
  get: function (e, r) {
  ...
  set: function (e, r, o) {
    ...
    return Pe(r)
      ? (process.env.NODE_ENV !== 'production' &&
          !we(e).values_.has(r) &&
          st("add a new observable property through direct assignment. Use 'set' from 'mobx' instead."),
        (a = we(e).set_(r, o, !0)) != null ? a : !0)
      : !1;
  },
  deleteProperty: function (e, r) {
    var o;
    return (
      process.env.NODE_ENV !== 'production' && st("delete properties from an observable object. Use 'remove' from 'mobx' instead."),
      Pe(r) ? ((o = we(e).delete_(r, !0)) != null ? o : !0) : !1
    );
  },
  defineProperty: function (e, r, o) {
    var a;
    return (
      process.env.NODE_ENV !== 'production' && st("define property on an observable object. Use 'defineProperty' from 'mobx' instead."),
      (a = we(e).defineProperty_(r, o)) != null ? a : !0
    );
  },
  ownKeys: function (e) {
    return (
      process.env.NODE_ENV !== 'production' &&
        p.trackingDerivation &&
        st("iterate keys to detect added / removed properties. Use 'keys' from 'mobx' instead."),
      we(e).ownKeys_()
    );
  },
...
function Q(t, e) {
  var r = Me(),
    o = t.changeListeners_;
  if (o) {
    o = o.slice();
    for (var a = 0, i = o.length; a < i; a++) o[a](e);
    le(r);
  }
}
...
function Ct(t, e, r) {
  return (
    process.env.NODE_ENV !== 'production' &&
      (!C(t) && !C(Object.getPrototypeOf(t)) && h("'makeAutoObservable' can only be used for classes that don't have a superclass"),
      rt(t) && h('makeAutoObservable can only be used on objects not already made observable')),
    C(t)
      ? ti(t, t, e, r)
      : (Ue(function () {
          var o = tt(t, r)[g];
...
var Oo = 'splice',
  ...
  ao = /* @__PURE__ */ (function () {
    function t(r, o, a, i) {
      (r === void 0 && (r = process.env.NODE_ENV !== 'production' ? 'ObservableArray@' + X() : 'ObservableArray'),
        (this.owned_ = void 0),
    ...
    return (
      ...
      (e.setArrayLength_ = function (o) {
        ...
        if (o !== a)
          if (o > a) {
            for (var i = new Array(o - a), n = 0; n < o - a; n++) i[n] = void 0;
      ...
      (e.spliceWithArray_ = function (o, a, i) {
        ...
        if (
          (o === void 0 ? (o = 0) : o > s ? (o = s) : o < 0 && (o = Math.max(0, s + o)),
          arguments.length === 1 ? (a = s - o) : a == null ? (a = 0) : (a = Math.max(0, Math.min(a, s - o))),
          i === void 0 && (i = Xt),
          M(this))
        ) {
          var l = U(this, {
      ...
      (e.spliceItemsIntoValues_ = function (o, a, i) {
        if (i.length < Ps) {
          ...
          var s = this.values_.slice(o, o + a),
            l = this.values_.slice(o + a);
          this.values_.length += i.length - a;
          for (var c = 0; c < i.length; c++) this.values_[o + c] = i[c];
          for (var d = 0; d < l.length; d++) this.values_[o + i.length + d] = l[d];
          return s;
        }
      }),
        ...
        var n = !this.owned_ && P(),
          ...
          l =
            s || n
              ...
              : null;
        (process.env.NODE_ENV !== 'production' && n && R(l),
      ...
      (e.set_ = function (o, a) {
        ...
        if ((this.legacyMode_ && o > i.length && h(17, o, i.length), o < i.length)) {
          ...
          for (var c = new Array(o + 1 - i.length), d = 0; d < c.length - 1; d++) c[d] = void 0;
...
var Bt = {
  ...
  push: function () {
    for (var e = this[g], r = arguments.length, o = new Array(r), a = 0; a < r; a++) o[a] = arguments[a];
  ...
  remove: function (e) {
    var r = this[g],
      o = r.dehanceValues_(r.values_).indexOf(e);
...
function ai(t) {
  return function () {
    ...
    var o = r.dehanceValues_(r.values_),
      a = arguments[0];
    return (
      (arguments[0] = function (i, n, s) {
        return a(i, n, s, e);
      }),
...
var Ts = {},
  ...
  ii = /* @__PURE__ */ (function () {
    function t(r, o, a) {
      var i = this;
      (o === void 0 && (o = Ve),
        a === void 0 && (a = process.env.NODE_ENV !== 'production' ? 'ObservableMap@' + X() : 'ObservableMap'),
        (this.enhancer_ = void 0),
        (this.name_ = void 0),
        (this[g] = Ts),
        (this.data_ = void 0),
        ...
        E(Map) || h(18),
        Ue(function () {
          ((i.keysAtom_ = Va(process.env.NODE_ENV !== 'production' ? i.name_ + '.keys()' : 'ObservableMap.keys()')),
            (i.data_ = /* @__PURE__ */ new Map()),
            (i.hasMap_ = /* @__PURE__ */ new Map()),
            r && i.merge(r));
        }));
    }
    var e = t.prototype;
    return (
      ...
      (e.has = function (o) {
        var a = this;
        if (!p.trackingDerivation) return this.has_(o);
        var i = this.hasMap_.get(o);
        if (!i) {
          var n = (i = new Ae(
            this.has_(o),
            pr,
            process.env.NODE_ENV !== 'production' ? this.name_ + '.' + qr(o) + '?' : 'ObservableMap.key?',
            !1,
          ));
          (this.hasMap_.set(o, n),
            $a(n, function () {
      ...
      (e.addValue_ = function (o, a) {
        ...
        (G(this.keysAtom_),
          se(function () {
            var c,
              d = new Ae(a, i.enhancer_, process.env.NODE_ENV !== 'production' ? i.name_ + '.' + qr(o) : 'ObservableMap.key', !1);
      ...
      (e.replace = function (o) {
        ...
        return (
          se(function () {
            ...
            if (!s)
              if (a.data_.size !== n.size) a.keysAtom_.reportChanged();
              else
      ...
      (e.observe_ = function (o, a) {
        return (
          process.env.NODE_ENV !== 'production' &&
            a === !0 &&
            h("`observe` doesn't support fireImmediately=true in combination with maps."),
          Vt(this, o)
        );
      }),
      (e.intercept_ = function (o) {
...
var zs = {},
  ni = /* @__PURE__ */ (function () {
    function t(r, o, a) {
      var i = this;
      (o === void 0 && (o = Ve),
        a === void 0 && (a = process.env.NODE_ENV !== 'production' ? 'ObservableSet@' + X() : 'ObservableSet'),
        (this.name_ = void 0),
        (this[g] = zs),
    ...
    return (
      ...
      (e.add = function (o) {
        ...
        if (!this.has(o)) {
          ...
          var n = process.env.NODE_ENV !== 'production' && P(),
            s = K(this),
            l =
              s || n
                ? {
          ...
          var n = process.env.NODE_ENV !== 'production' && P(),
            ...
            l =
              s || n
                ...
                : null;
          return (
            n && process.env.NODE_ENV !== 'production' && R(l),
            se(function () {
              (a.atom_.reportChanged(), a.data_.delete(o));
            }),
            s && Q(this, l),
            n && process.env.NODE_ENV !== 'production' && q(),
            !0
          );
        }
        return !1;
      ...
      (e.intersection = function (o) {
        if (ie(o) && !Y(o)) return o.intersection(this);
        var a = new Set(this);
        return a.intersection(o);
      }),
      (e.union = function (o) {
        if (ie(o) && !Y(o)) return o.union(this);
        var a = new Set(this);
        return a.union(o);
      }),
      ...
      (e.symmetricDifference = function (o) {
        if (ie(o) && !Y(o)) return o.symmetricDifference(this);
        var a = new Set(this);
      ...
      (e.isDisjointFrom = function (o) {
        if (ie(o) && !Y(o)) return o.isDisjointFrom(this);
        var a = new Set(this);
      ...
      (e.observe_ = function (o, a) {
        return (
          process.env.NODE_ENV !== 'production' &&
            a === !0 &&
            h("`observe` doesn't support fireImmediately=true in combination with sets."),
          Vt(this, o)
        );
      }),
      (e.intercept_ = function (o) {
  ...
  Xr = /* @__PURE__ */ (function () {
    function t(r, o, a, i) {
      (o === void 0 && (o = /* @__PURE__ */ new Map()),
        ...
        (this.keysAtom_ = new fe(process.env.NODE_ENV !== 'production' ? this.name_ + '.keys' : 'ObservableObject.keys')),
        (this.isPlainObject_ = C(this.target_)),
        process.env.NODE_ENV !== 'production' && !pi(this.defaultAnnotation_) && h('defaultAnnotation must be valid annotation'),
        process.env.NODE_ENV !== 'production' && (this.appliedAnnotations_ = {}));
    }
    var e = t.prototype;
    return (
      (e.getObservablePropValue_ = function (o) {
        return this.values_.get(o).get();
      }),
      (e.setObservablePropValue_ = function (o, a) {
        var i = this.values_.get(o);
        if (i instanceof F) return (i.set(a), !0);
        if (M(this)) {
          var n = U(this, {
            type: H,
          ...
          var s = K(this),
            ...
            c =
              s || l
                ...
                : null;
          (process.env.NODE_ENV !== 'production' && l && R(c),
            i.setNewValue_(a),
            s && Q(this, c),
            process.env.NODE_ENV !== 'production' && l && q());
        }
        return !0;
      }),
      (e.get_ = function (o) {
      ...
      (e.has_ = function (o) {
        if (!p.trackingDerivation) return o in this.target_;
        ...
        return (
          a ||
            ((a = new Ae(
              o in this.target_,
              pr,
              process.env.NODE_ENV !== 'production' ? this.name_ + '.' + qr(o) + '?' : 'ObservableObject.key?',
              !1,
            )),
      ...
      (e.make_ = function (o, a) {
        if ((a === !0 && (a = this.defaultAnnotation_), a !== !1)) {
          if ((Do(this, a, o), !(o in this.target_))) {
            var i;
            if ((i = this.target_[ne]) != null && i[o]) return;
      ...
      (e.extend_ = function (o, a, i, n) {
        if ((n === void 0 && (n = !1), i === !0 && (i = this.defaultAnnotation_), i === !1)) return this.defineProperty_(o, a, n);
        Do(this, i, o);
      ...
      (e.defineComputedProperty_ = function (o, a, i) {
        ...
        try {
          ...
          (a.name || (a.name = process.env.NODE_ENV !== 'production' ? this.name_ + '.' + o.toString() : 'ObservableObject.key'),
          ...
          if (i) {
            if (!Reflect.defineProperty(this.target_, o, c)) return !1;
          } else $(this.target_, o, c);
      ...
      (e.delete_ = function (o, a) {
        if ((a === void 0 && (a = !1), G(this.keysAtom_), !J(this.target_, o))) return !0;
        if (M(this)) {
          var i = U(this, {
            object: this.proxy_ || this.target_,
            name: o,
        ...
        try {
          ...
          if (
            (process.env.NODE_ENV !== 'production' && delete this.appliedAnnotations_[o],
            c && (this.values_.delete(o), c instanceof Ae && (d = c.value_), Xa(c)),
            this.keysAtom_.reportChanged(),
            (n = this.pendingKeys_) == null || (n = n.get(o)) == null || n.set(o in this.target_),
            s || l)
          ) {
            var v = {
              type: Co,
      ...
      (e.observe_ = function (o, a) {
        return (
          process.env.NODE_ENV !== 'production' &&
            a === !0 &&
            h("`observe` doesn't support the fire immediately property for observable objects."),
          Vt(this, o)
        );
      }),
      (e.intercept_ = function (o) {
      ...
      (e.notifyPropertyAddition_ = function (o, a) {
        var i,
          n = K(this),
          s = process.env.NODE_ENV !== 'production' && P();
        if (n || s) {
          var l =
            n || s
              ? {
...
Extending builtins is not supported.`,
  ...
  process.env.NODE_ENV !== 'production' &&
    ...
    h('Cannot make the designated object observable; it is not extensible');
  var o =
      (r = e?.name) != null
        ? r
        : process.env.NODE_ENV !== 'production'
          ? (C(t) ? 'ObservableObject' : t.constructor.name) + '@' + X()
          : 'ObservableObject',
    a = new Xr(t, /* @__PURE__ */ new Map(), String(o), Un(e));
  return (cr(t, g, a), t);
}
...
function Do(t, e, r) {
  if (
    (process.env.NODE_ENV !== 'production' && !pi(e) && h("Cannot annotate '" + t.name_ + '.' + r.toString() + "': Invalid annotation."),
    process.env.NODE_ENV !== 'production' && !Ht(e) && J(t.appliedAnnotations_, r))
  ) {
    var o = t.name_ + '.' + r.toString(),
      a = t.appliedAnnotations_[r].annotationType_,
      i = e.annotationType_;
    h(
      "Cannot apply '" +
        i +
...
var io = /* @__PURE__ */ (function (t) {
  function e(o, a, i, n) {
    var s;
    return (
      i === void 0 && (i = process.env.NODE_ENV !== 'production' ? 'ObservableArray@' + X() : 'ObservableArray'),
      n === void 0 && (n = !1),
      (s = t.call(this) || this),
      Ue(function () {
...
function De(t, e) {
  if (typeof t == 'object' && t !== null) {
    if (br(t)) return (e !== void 0 && h(23), t[g].atom_);
    if (Y(t)) return t.atom_;
    if (ge(t)) {
    ...
    if ($r(t) || gr(t) || Qt(t)) return t;
  } else if (E(t) && Qt(t[g])) return t[g];
  h(28);
}
function Nt(t, e) {
  if ((t || h(29), e !== void 0)) return Nt(De(t, e));
  if ($r(t) || gr(t) || Qt(t) || ge(t) || Y(t)) return t;
  if (t[g]) return t[g];
  h(24, t);
}
function Gt(t, e) {
  var r;
  if (e !== void 0) r = De(t, e);
  else {
    if (Te(t)) return t.name;
...
function Hr(t, e, r, o, a) {
  ...
  if (t !== t) return e !== e;
  var i = typeof t;
  if (i !== 'function' && i !== 'object' && typeof e != 'object') return !1;
  var n = zo.call(t);
  if (n !== zo.call(e)) return !1;
  switch (n) {
  ...
  if (!s) {
    ...
    var l = t.constructor,
      c = e.constructor;
    if (l !== c && !(E(l) && l instanceof l && E(c) && c instanceof c) && 'constructor' in t && 'constructor' in e) return !1;
  }
  if (r === 0) return !1;
  (r < 0 && (r = -1), (o = o || []), (a = a || []));
  for (var d = o.length; d--; ) if (o[d] === t) return a[d] === e;
  if ((o.push(t), a.push(e), s)) {
    if (((d = t.length), d !== e.length)) return !1;
    for (; d--; ) if (!Hr(t[d], e[d], r - 1, o, a)) return !1;
  } else {
    var u = Object.keys(t),
      v = u.length;
    if (Object.keys(e).length !== v) return !1;
    for (var b = 0; b < v; b++) {
      var w = u[b];
      if (!(J(e, w) && Hr(t[w], e[w], r - 1, o, a))) return !1;
    }
  }
...
var Ro,
  Zs = ((Ro = Yr().Iterator) == null ? void 0 : Ro.prototype) || {};
function no(t) {
...
const We = {
  ...
  Ws = /* @__PURE__ */ new Set([We.DEVELOPMENT_SETUP, We.FEATURES, We.FEEDBACK, We.INFO, We.LOG, We.IMPERSONATOR]);
function Fs(t) {
  return Ws.has(t);
}
const Xs = Symbol.for('react.portal'),
...
function Cd() {
  ...
  return (
    Array.from(document.body.querySelectorAll('*'))
      .flatMap(ol)
      .filter(tl)
      .filter(r => !r.fileName.includes('frontend/generated/'))
      .forEach(r => t.add(r.fileName)),
    Array.from(t)
  );
}
function tl(t) {
...
function $t(t) {
  ...
  if (e?.fileName && e?.lineNumber) return e;
}
function rl(t) {
  if (t && t.type?.__debugSourceDefine) return t.type.__debugSourceDefine;
}
function ol(t) {
  return $t(er(t));
}
...
function hi() {
  if (
    !(
      !zt &&
      ((zt = Array.from(document.querySelectorAll('*'))
        .flatMap(t => Object.keys(t))
        .filter(t => t.startsWith('__reactFiber$'))
        .map(t => t.replace('__reactFiber$', ''))
        .find(t => t)),
      !zt)
    )
  )
...
function ze(t) {
  const e = t?.stateNode;
  if (e?.current && (ll(e) || cl(e))) return e?.current;
  if (!t) return;
  if (!t.alternate) return t;
  const r = t.alternate,
    o = t?.actualStartTime,
    a = r?.actualStartTime;
  return a !== o && a > o ? r : t;
...
function er(t) {
  ...
  for (; o && !$t(o); ) o = o.return || void 0;
  return o;
}
function tr(t) {
  if (t.stateNode?.isConnected === !0) return t.stateNode;
  if (t.child) return tr(t.child);
}
function Lo(t) {
  const e = tr(t);
  return e && ze(er(e)) === t;
...
const mr = async (t, e, r) => window.Vaadin.copilot.comm(t, e, r),
  ot = 'copilot-',
  pl = '25.1.3',
  ul = 'undefined',
  Nd = 'attention-required',
  Td = 'https://plugins.jetbrains.com/plugin/23758-vaadin',
  Dd = 'https://marketplace.visualstudio.com/items?itemName=vaadin.vaadin-vscode',
  zd = 'https://marketplace.eclipse.org/content/vaadin-tools';
function Id(t) {
  return t === void 0 ? !1 : t.nodeId >= 0;
}
function hl(t) {
  if (t.javaClass) return t.javaClass.substring(t.javaClass.lastIndexOf('.') + 1);
}
function It(t) {
  const e = window.Vaadin;
  if (e && e.Flow) {
    const { clients: r } = e.Flow,
      o = Object.keys(r);
    for (const a of o) {
      const i = r[a];
      if (i.getNodeId) {
...
function Ld(t) {
  if (t) {
    if (typeof t == 'string') return t;
    if (!bl(t)) throw new Error(`Expected message to be a string or an observable value but was ${JSON.stringify(t)}`);
    return t.get();
  }
}
function ml(t) {
...
function Mo(t) {
  ...
  function n(c) {
    if (!c) return !1;
    for (let d = 0; d < c.length; d++) if (c[d]?.startsWith(e)) return !0;
    return !1;
  }
  function s(c) {
    ...
    if (i(c)) {
      const d = c.cssRules;
      for (const u of d) if (s(u)) return !0;
    }
  ...
  for (const c of Array.from([...document.adoptedStyleSheets, ...document.styleSheets])) if (o(c) && l(c)) return !0;
  return !1;
}
function Md(t) {
  return t?.replace(/^.*[\\/]/, '');
...
class wl {
  constructor() {
    ((this.loginCheckActive = !1),
      (this.userInfo = void 0),
      (this.operationInProgress = void 0),
      (this.operationWaitsHmrUpdate = void 0),
      (this.operationWaitsHmrUpdateTimeout = void 0),
      (this.idePluginState = void 0),
      (this.notifications = []),
      (this.infoTooltip = null),
      (this.sectionPanelDragging = !1),
      (this.sectionPanelResizing = !1),
      (this.drawerResizing = !1),
      (this.featureFlags = []),
      (this.newVaadinVersionState = void 0),
      (this.pointerEventsDisabledForScrolling = !1),
      (this.editComponent = void 0),
      (this.serverRestartRequiringToggledFeatureFlags = []),
      (this.appTheme = void 0),
      (this.activeMode = 'play'),
      (this.projectInfoEntries = void 0),
      (this.publicPluginsState = 'NOT_INITIALIZED'),
      (this.privatePluginsState = 'NOT_INITIALIZED'),
      (this.lastNonPlayMode = void 0),
      (this.projectVersionReleaseNoteInfo = null),
      Ct(this, {
  ...
  startOperation(e) {
    if (this.operationInProgress) throw new Error(`An ${e} operation is already in progress`);
  ...
  stopOperation(e) {
    if (this.operationInProgress) {
      if (this.operationInProgress !== e) return;
    } else return;
    this.operationInProgress = void 0;
  }
  ...
  toggleServerRequiringFeatureFlag(e) {
    const r = [...this.serverRestartRequiringToggledFeatureFlags],
      o = r.findIndex(a => a.id === e.id);
...
const gi = (t, e, r) => e >= t.left && e <= t.right && r >= t.top && r <= t.bottom,
  bi = t => {
    const e = [];
    let r = Uo(t);
    for (; r; ) (e.push(r), (r = Uo(r)));
    return e;
  },
  mi = t => {
    if (t.length === 0) return new DOMRect();
  ...
  or = (t, e) => {
    ...
    for (; !(r instanceof HTMLElement && r.localName === `${ot}main`); ) {
      ...
      else if (r.host) r = r.host;
      else return null;
      if (r instanceof HTMLElement && r.localName === e) return r;
    }
    return null;
  };
function Uo(t) {
...
function Jr(t) {
  if (t.assignedSlot) return Jr(t.assignedSlot);
  if (t.parentElement) return t.parentElement;
  if (t.parentNode instanceof ShadowRoot) return t.parentNode.host;
}
function ke(t) {
...
function Wo(t) {
  ...
  if (e) return e.outerText.trim();
  const r = Array.from(t.childNodes).find(o => o.nodeType === Node.TEXT_NODE && o.textContent && o.textContent.trim().length > 0);
  if (r && r.textContent) return r.textContent.trim();
}
function xl(t) {
...
function El(t) {
  ...
  for (; e && e !== document.body; ) {
    const r = window.getComputedStyle(e),
      o = r.overflowY,
      a = r.overflowX,
      i = /(auto|scroll)/.test(o) && e.scrollHeight > e.clientHeight,
      n = /(auto|scroll)/.test(a) && e.scrollWidth > e.clientWidth;
    if (i || n) return e;
    e = Jr(e);
  }
...
function Zd(t, e) {
  function r(o) {
    if (o instanceof ShadowRoot)
      ...
      if (o.tagName.toLowerCase() === e.toLowerCase()) return o;
      for (const a of o.children) {
        const i = r(a);
        if (i) return i;
      }
...
function Vl(t) {
  ...
  return (
    (e === 0 && r === 0) || // Safari and Firefox returns the last position where mouse left the screen with adding some offset value, something like 356, -1.
    !gi(document.documentElement.getBoundingClientRect(), e, r)
  );
}
function Fo(t) {
  if (t.localName === 'vaadin-login-overlay' || t.localName === 'vaadin-dialog') return !1;
  const e = xl(t);
...
var wi = /* @__PURE__ */ (t => (
  (t['vaadin-combo-box'] = 'vaadin-combo-box'),
  (t['vaadin-date-picker'] = 'vaadin-date-picker'),
  (t['vaadin-dialog'] = 'vaadin-dialog'),
  (t['vaadin-multi-select-combo-box'] = 'vaadin-multi-select-combo-box'),
  (t['vaadin-select'] = 'vaadin-select'),
  (t['vaadin-time-picker'] = 'vaadin-time-picker'),
  (t['vaadin-popover'] = 'vaadin-popover'),
  t
))(wi || {});
const Fe = {
    'vaadin-combo-box': {
...
class Nl {
  constructor() {
    ((this.openedOverlayOwners = /* @__PURE__ */ new Set()),
      (this.overlayCloseEventListener = e => {
        ke(e.detail?.overlay) ||
          ((window.Vaadin.copilot._uiState.active || ke(e.detail.sourceEvent?.target)) &&
  ...
  activate() {
    ...
    r &&
      (r.hideOnActivation && r.close
        ? r.close(e)
        : document.body.style.getPropertyValue('pointer-events') === 'none' && document.body.style.removeProperty('pointer-events'));
  }
  ...
  getOwner(e) {
    const r = e;
    if (r._comboBox) return r._comboBox._comboBox ?? r._comboBox;
    if (r.owner) return r.owner;
    if (r?.__focusRestorationController?.focusNode?.parentElement) return r?.__focusRestorationController?.focusNode?.parentElement;
  }
  ...
  overlayStatus(e) {
    ...
    if (!o) return { visible: !1 };
    const a = Fe[e.localName];
    if (!a.open || !a.close) return { visible: !1 };
...
async function Tl() {
  return gl(() => {
    const t = window.Vaadin.devTools,
      e = t?.frontendConnection && t?.frontendConnection.status === 'active';
...
class Dl {
  constructor() {
    ((this.dismissedNotifications = []),
      (this.activationButtonPosition = null),
      (this.paletteState = null),
      (this.activationShortcut = !0),
      (this.recentSwitchedUsernames = []),
      (this.newVersionPreReleasesVisible = !1),
      (this.aiUsageAllowed = 'ask'),
      (this.sendErrorReportsAllowed = !0),
      (this.feedbackDisplayedAtLeastOnce = !1),
      (this.aiProvider = 'ANY'),
      (this.experimentalFeatures = {}),
      (this.selectedSize = null),
      (this.selectedTheme = null),
      (this.mostRecentVaadinVersion = null),
      (this.mostRecentReleaseNoteDismissed = !0),
      (this.toolbarExpandMode = 'proximity'),
      (this.badgePositionMode = 'smart'),
      Ct(this),
      (this.initializer = new Ei()),
      this.initializer.promise.then(() => {
        oo(
          () => JSON.stringify(this),
          () => {
...
class O {
  ...
  static saveCurrentSelection(e) {
    ...
    ((r.selection = r.selection ?? {}),
      r.selection && ((r.selection.current = e), (r.selection.location = window.location.pathname), this.persist(r)));
  }
  static savePendingSelection(e) {
    const r = this.sessionConfiguration;
    ((r.selection = r.selection ?? {}),
      r.selection && ((r.selection.pending = e), (r.selection.location = window.location.pathname), this.persist(r)));
  }
  ...
  static saveDrillDownContextReference(e) {
    const r = this.sessionConfiguration;
    ((r.drillDownContext = r.drillDownContext ?? {}),
      r.drillDownContext && ((r.drillDownContext.location = window.location.pathname), (r.drillDownContext.stack = e), this.persist(r)));
  }
...
class zl {
  constructor() {
    ((this._panels = []),
      ...
      (this.renderedPanels = /* @__PURE__ */ new Set()),
      (this.customTags = k.map()),
      (this.openPanelTags = k.set()),
      (this.switchModeClosedPanelTags = /* @__PURE__ */ new Set()),
      (this.positionUpdatedManuallyPanelTags = k.set()),
      (this._panelStackingOrder = []),
      Ct(this),
  ...
  restorePositions() {
    ...
    e &&
      (this._panels = this._panels.map(r => {
  ...
  restorePanelTagsState() {
    const e = O.getOpenPanelTags(),
      r = O.getSwitchModeClosedPanelTags();
    (this.openPanelTags.clear(),
      this.switchModeClosedPanelTags.clear(),
      e.forEach(o => {
  ...
  updatePanel(e, r, o = !0) {
    const a = [...this._panels],
      i = a.find(n => n.tag === e);
    i &&
      (Object.assign(i, r),
      o &&
        r.position &&
        (this.positionUpdatedManuallyPanelTags.add(e), O.savePositionUpdatedManuallyPanelTags(this.positionUpdatedManuallyPanelTags)),
      this.renderedPanels.add(i.tag),
      (this._panels = a),
      O.savePanelConfigurations(this._panels));
  }
  removePanel(e) {
    const r = this._panels.findIndex(o => o.tag === e);
    r < 0 ||
      (this.positionUpdatedManuallyPanelTags.delete(e),
      O.savePositionUpdatedManuallyPanelTags(this.positionUpdatedManuallyPanelTags),
      this._panels.splice(r, 1),
      this.openPanelTags.delete(e),
      this.switchModeClosedPanelTags.delete(e),
      O.savePanelConfigurations(this._panels),
  ...
  closePanel(e) {
    this.openPanelTags.delete(e);
    const r = [...this._panelStackingOrder],
      o = this._panelStackingOrder.indexOf(e);
  ...
  restorePanelsFromStorage() {
    (this.restorePanelTagsState(),
      this.restoreCustomTags(),
      this.restorePositionUpdatedManuallyPanelTags(),
      this.restoreStackingOrderPanelTags());
  }
  getOpenPanelTags() {
...
class Il {
  constructor() {
    ((this.supportsHilla = !0),
      (this.springSecurityEnabled = !1),
      (this.springJpaDataEnabled = !1),
      (this.springJpaDatasourceInitialization = !1),
      (this.springApplication = !1),
      (this.urlPrefix = ''),
      (this.serverVersions = []),
      (this.clientVersions = [{ name: 'Browser', version: navigator.userAgent }]),
      Ct(this));
  }
  setSupportsHilla(e) {
...
class Rl {
  ...
  addPaletteCustomComponent(e) {
    return (this.palette?.components ?? []).find(a => Cr(a, e))
      ? !1
      : (this.palette || (this.palette = { components: [] }),
        (this.palette = JSON.parse(JSON.stringify(this.palette))),
        this.palette.components.push(e),
        !0);
  }
  removePaletteCustomComponent(e) {
    if (this.palette) {
      const r = this.palette.components.findIndex(o => Cr(o, e));
      r > -1 && this.palette.components.splice(r, 1);
    }
  }
  updatePaletteCustomComponent(e, r) {
    if (!this.palette || !this.palette.components) return;
    const o = [...this.palette.components],
      a = o.findIndex(i => Cr(i, e));
    (a !== -1 && (o[a] = { ...e, ...r }), (this.palette.components = o));
  }
  paletteCustomComponentExist(e, r) {
    return !this.palette || !this.palette.components
      ? !1
      : e
        ? this.palette.components.findIndex(o => o.java && !o.react && o.javaClassName === e) !== -1
        : r
          ? this.palette.components.findIndex(o => !o.java && o.react && o.template === r) !== -1
          : !1;
  }
...
const jt = globalThis,
  so =
    jt.ShadowRoot &&
    (jt.ShadyCSS === void 0 || jt.ShadyCSS.nativeShadow) &&
...
const V = t => new Ai(typeof t == 'string' ? t : t + '', void 0, lo),
  ql = (t, ...e) => {
    const r =
      t.length === 1
        ? t[0]
...
const {
    ...
    getOwnPropertySymbols: Wl,
    getPrototypeOf: Fl,
  } = Object,
  wr = globalThis,
  Yo = wr.trustedTypes,
  Xl = Yo ? Yo.emptyScript : '',
  Hl = wr.reactiveElementPolyfillSupport,
  vt = (t, e) => t,
  ar = {
    toAttribute(t, e) {
      switch (e) {
  ...
  co = (t, e) => !Ml(t, e),
  Go = { attribute: !0, type: String, converter: ar, reflect: !1, useDefault: !1, hasChanged: co };
...
let He = class extends HTMLElement {
  ...
  static createProperty(e, r = Go) {
    if (
      ...
      const o = Symbol(),
        a = this.getPropertyDescriptor(e, o, r);
      a !== void 0 && Ul(this.prototype, e, a);
    }
  }
  static getPropertyDescriptor(e, r, o) {
    const { get: a, set: i } = Zl(this.prototype, e) ?? {
      get() {
        return this[r];
      },
      set(n) {
  ...
  _$AK(e, r) {
    ...
    if (a !== void 0 && this._$Em !== a) {
      const i = o.getPropertyOptions(a),
        n = typeof i.converter == 'function' ? { fromAttribute: i.converter } : i.converter?.fromAttribute !== void 0 ? i.converter : ar;
  ...
  requestUpdate(e, r, o) {
    if (e !== void 0) {
      const a = this.constructor,
        i = this[e];
      if (
        ((o ??= a.getPropertyOptions(e)),
        !((o.hasChanged ?? co)(i, r) || (o.useDefault && o.reflect && i === this._$Ej?.get(e) && !this.hasAttribute(a._$Eu(e, o)))))
      )
        return;
      this.C(e, r, o);
    }
  ...
  C(e, r, { useDefault: o, reflect: a, wrapped: i }, n) {
    (o && !(this._$Ej ??= /* @__PURE__ */ new Map()).has(e) && (this._$Ej.set(e, n ?? r ?? this[e]), i !== !0 || n !== void 0)) ||
      (this._$AL.has(e) || (this.hasUpdated || o || (r = void 0), this._$AL.set(e, r)),
      a === !0 && this._$Em !== e && (this._$Eq ??= /* @__PURE__ */ new Set()).add(e));
  }
  async _$EP() {
...
((He.elementStyles = []),
  ...
  (He[vt('elementProperties')] = /* @__PURE__ */ new Map()),
  (He[vt('finalized')] = /* @__PURE__ */ new Map()),
  Hl?.({ ReactiveElement: He }),
  (wr.reactiveElementVersions ??= []).push('2.1.0'));
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Jl = { attribute: !0, type: String, converter: ar, reflect: !1, hasChanged: co },
  Kl = (t = Jl, e, r) => {
    const { kind: o, metadata: a } = r;
    let i = globalThis.litPropertyMetadata.get(a);
    if (
      (i === void 0 && globalThis.litPropertyMetadata.set(a, (i = /* @__PURE__ */ new Map())),
      o === 'setter' && ((t = Object.create(t)).wrapped = !0),
      i.set(r.name, t),
      o === 'accessor')
    ) {
      const { name: n } = r;
...
const Xe = Symbol('LitMobxRenderReaction'),
  _o = Symbol('LitMobxRequestUpdate');
function Bl(t, e) {
  var r, o;
  return (
    (o = class extends t {
...
const uo = globalThis,
  ir = uo.trustedTypes,
  $o = ir ? ir.createPolicy('lit-html', { createHTML: t => t }) : void 0,
  Pi = '$lit$',
  ue = `lit$${Math.random().toFixed(9).slice(2)}$`,
  Vi = '?' + ue,
  Gl = `<${Vi}>`,
  Ie = document,
  wt = () => Ie.createComment(''),
  xt = t => t === null || (typeof t != 'object' && typeof t != 'function'),
  ho = Array.isArray,
  _l = t => ho(t) || typeof t?.[Symbol.iterator] == 'function',
  Nr = `[ 	
\f\r]`,
...
\f\r"'\`<>=]|("|')|))|$)`,
  ...
  ra = /'/g,
  oa = /"/g,
  Ci = /^(?:script|style|textarea|title)$/i,
  Ni =
    t =>
        ...
        n === lt
          ? d[1] === '!--'
            ...
            : d[1] !== void 0
              ? (n = ta)
              : d[2] !== void 0
                ? (Ci.test(d[2]) && (a = RegExp('</' + d[2], 'g')), (n = xe))
                : d[3] !== void 0 && (n = xe)
          : n === xe
            ? d[0] === '>'
              ? ((n = a ?? lt), (u = -1))
              : d[1] === void 0
                ? (u = -2)
                : ((u = n.lastIndex - d[2].length), (c = d[1]), (n = d[3] === void 0 ? xe : d[3] === '"' ? oa : ra))
            : n === oa || n === ra
              ? (n = xe)
              : n === ea || n === ta
                ? (n = lt)
      ...
      if (a.nodeType === 1) {
        if (a.hasAttributes())
          for (const u of a.getAttributeNames())
            if (u.endsWith(Pi)) {
              const v = d[n++],
                b = a.getAttribute(u).split(ue),
                w = /([.?@])?(.*)/.exec(v);
              (l.push({ type: 1, index: i, name: w[2], strings: b, ctor: w[1] === '.' ? tc : w[1] === '?' ? rc : w[1] === '@' ? oc : xr }),
                a.removeAttribute(u));
            } else u.startsWith(ue) && (l.push({ type: 6, index: i }), a.removeAttribute(u));
        if (Ci.test(a.tagName)) {
          const u = a.textContent.split(ue),
            v = u.length - 1;
          if (v > 0) {
        ...
        if (a.data === Vi) l.push({ type: 2, index: i });
        else {
          let u = -1;
...
function _e(t, e, r = t, o) {
  ...
  return (
    a?.constructor !== i &&
      (a?._$AO?.(!1),
      i === void 0 ? (a = void 0) : ((a = new i(t)), a._$AT(t, r, o)),
      o !== void 0 ? ((r._$Co ??= [])[o] = a) : (r._$Cl = a)),
    a !== void 0 && (e = _e(t, a._$AS(t, e.values), a, o)),
    e
  );
}
class ec {
  ...
  u(e) {
    const {
      ...
      a = (e?.creationScope ?? Ie).importNode(r, !0);
    Ee.currentNode = a;
    let i = Ee.nextNode(),
      n = 0,
      s = 0,
    ...
    for (; l !== void 0; ) {
      if (n === l.index) {
        let c;
        (l.type === 2
          ? (c = new it(i, i.nextSibling, this, e))
          : l.type === 1
            ? (c = new l.ctor(i, l.name, l.strings, this, e))
            : l.type === 6 && (c = new ac(i, this, e)),
          this._$AV.push(c),
          (l = o[++s]));
      }
...
class it {
  ...
  $(e) {
    const { values: r, _$litType$: o } = e,
      a = typeof o == 'number' ? this._$AC(e) : (o.el === void 0 && (o.el = St.createElement(Ti(o.h, o.h[0]), this.options)), o);
    if (this._$AH?._$AD === a) this._$AH.p(r);
    else {
      const i = new ec(a, this),
        n = i.u(this.options);
  ...
  _$AI(e, r = this, o, a) {
    ...
    if (i === void 0) ((e = _e(this, e, r, 0)), (n = !xt(e) || (e !== this._$AH && e !== Re)), n && (this._$AH = e));
      ...
      for (e = i[0], l = 0; l < i.length - 1; l++)
        ((c = _e(this, s[o + l], r, l)),
          c === Re && (c = this._$AH[l]),
          (n ||= !xt(c) || c !== this._$AH[l]),
          c === S ? (e = S) : e !== S && (e += (c ?? '') + i[l + 1]),
          (this._$AH[l] = c));
    }
    n && !a && this.j(e);
  }
...
class oc extends xr {
  ...
  _$AI(e, r = this) {
    ...
    const o = this._$AH,
      a = (e === S && o !== S) || e.capture !== o.capture || e.once !== o.once || e.passive !== o.passive,
      i = e !== S && (o === S || a);
...
let Be = class extends He {
  ...
  update(e) {
    ...
    (this.hasUpdated || (this.renderOptions.isConnected = this.isConnected),
      super.update(e),
      (this._$Do = nc(r, this.renderRoot, this.renderOptions)));
  }
  connectedCallback() {
...
if (!Oe) throw new Error('Tried to access copilot section panel ui state before it was initialized.');
let ae = [];
const ia = [];
function na(t) {
  t.init({
...
let Di = !1;
function dc() {
  kt().publicPluginsState === 'NOT_INITIALIZED' &&
    (ae.push(import('./copilot-log-plugin-BnMYU_Yf.js')),
    ae.push(import('./copilot-info-plugin-DeZSm4dx.js')),
    ae.push(import('./copilot-features-plugin-DRIeI3um.js')),
    ae.push(import('./copilot-feedback-plugin-Bm_UAamV.js')),
    ae.push(import('./copilot-settings-panel-BF6aixpk.js')),
    ae.push(import('./copilot-impersonator-plugin-prtgt3P1.js')),
    ae.push(import('./copilot-development-setup-user-guide-BFhQPCYl.js')),
    (Di = !0),
    kt().setPublicPluginsState('IMPORTED'));
}
function Tr() {
...
function pc() {
  (Promise.all(ae).then(() => {
    ...
    (ae = []),
    Di && kt().setPublicPluginsState('INITIALIZED'));
}
function kt() {
  return window.Vaadin.copilot._uiState;
}
const y = window.Vaadin.copilot.eventbus;
if (!y) throw new Error('Tried to access copilot eventbus before it was initialized.');
const Kr = window.Vaadin.copilot.overlayManager,
  uc = /* @__PURE__ */ Object.freeze(
...
if (!f) throw new Error('Tried to access copilot ui state before it was initialized.');
const hc = () => {
...
const bc = typeof crypto < 'u' && crypto.randomUUID && crypto.randomUUID.bind(crypto),
  sa = { randomUUID: bc };
function mc(t, e, r) {
  t = t || {};
...
const Wt = [],
  ...
  Yd = async (t, e, r) => {
    ...
    return (
      Wt.push({
        handleMessage(n) {
          if (n?.data?.reqId !== e.reqId) return !1;
          try {
            o(r(n));
          } catch (s) {
            a(s);
...
function yc(t) {
  for (const e of Wt) if (e.handleMessage(t)) return (Wt.splice(Wt.indexOf(e), 1), !0);
  if (y.emitUnsafe({ type: t.command, data: t.data })) return !0;
  for (const e of Ri()) if (Ii(e, t)) return !0;
  return (ut.push(t), !1);
}
function Ii(t, e) {
...
function wc() {
  if (ut.length) for (const t of Ri()) for (let e = 0; e < ut.length; e++) Ii(t, ut[e]) && (ut.splice(e, 1), e--);
}
function Ri() {
  ...
  const e = [];
  return (
    Array.from(t.shadowRoot.querySelectorAll('copilot-panel-manager vaadin-dialog[panel-container]')).forEach(r => {
...
class Qr extends qc {
  constructor(e) {
    if ((super(e), (this.it = S), e.type !== Ic.CHILD))
...
const Lc = Rc(Qr),
  _ = window.Vaadin.copilot._machineState;
if (!_) throw new Error('Trying to use stored machine state before it was initialized');
const Mc = 5e3;
let la = 1;
function qi(t) {
  f.notifications.includes(t) &&
    (t.dontShowAgain && t.dismissId && Uc(t.dismissId), f.removeNotification(t), y.emit('notification-dismissed', t));
}
function Li(t) {
...
function Wc(t) {
  ...
  return (
    f.setNotifications([...f.notifications, r]),
    requestAnimationFrame(() => {
      ((r.animatingIn = !1), f.setNotifications([...f.notifications]));
    }),
    (t.delay || (!t.link && !t.dismissId)) &&
      setTimeout(() => {
        qi(r);
      }, t.delay ?? Mc),
    y.emit('notification-shown', t),
    r
  );
}
const Fc = /* @__PURE__ */ Object.freeze(
    /* @__PURE__ */ Object.defineProperty(
      {
        __proto__: null,
  ...
  kr = window.Vaadin.copilot._earlyProjectState;
if (!kr) throw new Error('Tried to access early project state before it was initialized.');
function go() {
  return f.idePluginState?.supportedActions?.find(t => t === 'restartApplication');
}
function Xc() {
  mr(`${ot}plugin-restart-application`, {}, () => {}).catch(t => {
...
const Gd = (t, e) => (t.error ? (Kc(t.error, e), !0) : !1),
  ca = (t, e, r) => {
    yr({
      type: Ze.ERROR,
      message: t,
  ...
  Jc = (t, e, r, o, a) => {
    ...
    (a && i
      ...
      : ca(t, e),
      Hc() &&
        (o?.templateData && typeof o.templateData == 'string' && o.templateData.startsWith('data') && (o.templateData = '<IMAGE_DATA>'),
        y.emit('system-info-with-callback', {
          callback: n =>
            y.send('copilot-error', {
              message: t,
              details:
                String(r).replace(
                  '	',
...
function zr(t) {
  ...
  return (
    (e.length === 1 && e.includes('message')) ||
    (e.length >= 3 && e.includes('message') && e.includes('exceptionMessage') && e.includes('exceptionStacktrace'))
  );
}
function qe(t, e) {
  const r = zr(e) ? (e.exceptionMessage ?? e.message) : e,
    o = {
      type: Ze.ERROR,
...
function da(t) {
  return (
    t?.stack?.includes('cdn.vaadin.com/copilot') ||
    t?.stack?.includes('/copilot/copilot/') ||
    t?.stack?.includes('/copilot/copilot-private/')
  );
}
function Qc() {
  ...
  if (Array.isArray(e)) for (const r of e) Array.isArray(r) ? Ir.push(...r) : Ir.push(r);
  Yc(r => Ir.push(r));
}
function Bc(t, e, r, o, a, i) {
  const n = { ...t },
    s = window.Vaadin.copilot.tree,
    l = window.Vaadin.copilot.customComponentHandler;
  n.nodes.forEach(u => {
    u.node = s.allNodesFlat.find(v => {
      if (!v.isFlowComponent) return !1;
      const b = v.node;
      return b.uiId === u.uiId && b.nodeId === u.nodeId;
    });
  });
  const c = [];
  (r && c.push(`Error Message -> ${r}`),
    o && c.push(`Error Details -> ${o}`),
    c.push(`Active Level -> ${l.getActiveDrillDownContext() ? l.getActiveDrillDownContext()?.nameAndIdentifier : 'No active level'}`),
    n.nodes.length > 0 &&
      (c.push(`
Relevant Nodes:`),
      n.nodes.forEach(u => {
    ...
    n.relevantPairs.length > 0 &&
      (c.push(`
Additional Info:`),
      n.relevantPairs.forEach(u => {
...
function Yc(t) {
  ...
  window.Vaadin.ConsoleErrors = {
    push: r => {
      r[0] === null ||
        r[0] === void 0 ||
        (r[0].type !== void 0 && r[0].message !== void 0
          ? t({
              type: r[0].type,
              message: r[0].message,
          ...
          : t({ type: Ze.ERROR, message: r.map(o => Gc(o)).join(' '), internal: !1 }),
        e.push(r));
    },
  };
}
...
function $c() {
  ...
  function t(e, r = 100, o = {}) {
    ...
    if (r < 0) throw new RangeError('`wait` must not be negative.');
...
var ed = /* @__PURE__ */ $c();
const td = /* @__PURE__ */ _c(ed),
  rd = 'copilot-development-setup-user-guide';
function ep() {
...
function Ui() {
  ...
  return t
    ? t.jrebel
      ? 'success'
      : t.hotswapAgentFound
        ? !t.hotswapVersionOk || !t.runningWithExtendClassDef || !t.runningWitHotswap || !t.runningInJavaDebugMode
          ? 'error'
          : 'success'
        : 'warning'
    : null;
...
function rp() {
  if (!kr.jdkInfo) return { status: 'success' };
  const t = Ui(),
    e = od();
  return t === 'warning'
    ? e === 'warning'
      ? { status: 'warning', message: 'IDE Plugin, Hotswap' }
      : { status: 'warning', message: 'Hotswap is not enabled' }
    : e === 'warning'
      ? { status: 'warning', message: 'IDE Plugin is not active' }
      : t === 'error'
        ? { status: 'error', message: 'Hotswap is partially enabled' }
        : { status: 'success' };
}
function ad() {
  (re(`${ot}get-dev-setup-info`, {}),
    window.Vaadin.copilot.eventbus.on('copilot-get-dev-setup-info-response', t => {
      if (t.detail.content) {
...
class id {
  constructor() {
    ((this.root = null),
      (this.nodeUuidNodeMapFlat = /* @__PURE__ */ new Map()),
      (this.aborted = !1),
      (this._hasFlowComponent = !1),
      (this.flowNodesInSource = {}),
      (this.flowCustomComponentData = {}),
      (this.hillaCustomComponentData = {}),
      (this.componentDragDropApiInfosMap = {}),
      (this.waitForHillaCustomComponentResponseData = () =>
        new Promise((e, r) => {
          const o = setTimeout(() => {
  ...
  async init() {
    ...
    if (e) {
      ...
      (r && this.root?.abstractRootNode && this.root.children.length === 1 && (this.root = this.root.children[0]),
        r &&
          (await this.addOverlayContentToTreeIfExists('vaadin-popover[opened]'),
          await this.addOverlayContentToTreeIfExists('vaadin-dialog[opened]')),
        (this.hillaCustomComponentData = await this.waitForHillaCustomComponentResponseData()));
    }
  }
  getChildren(e) {
  ...
  getNodeOfElement(e) {
    if (e) return this.allNodesFlat.find(r => r.element === e);
  }
  /**
  ...
  async handleRouteContainers(e, r) {
    ...
    if (!o && vl(e)) {
      const a = tr(e);
      if (a && a.nextElementSibling) return (await this.addToTree(a.nextElementSibling, r), !0);
    }
  ...
  async includeFlowNode(e) {
    if (fl(e) || It(e)?.hiddenByServer) return !1;
    const r = It(e);
  ...
  async isInitializedInProjectSources(e) {
    ...
    if (!this.flowNodesInSource[a]) {
      ...
      (i.error && qe('Failed to get component source info', i.error),
        (this.flowCustomComponentData[a] = i.customComponentResponse),
        (this.flowNodesInSource[a] = new Set(i.nodeIdsInProject)),
        (this.componentDragDropApiInfosMap[a] = i.dragDropApiInfos));
    }
  ...
  async addToTree(e, r) {
    ...
    const a = Zo(e);
    let i;
    if (!a) this.includeReactNode(e) && (i = this.generateNodeFromFiber(e, r));
    else if (await this.includeFlowNode(e)) {
      const l = this.generateNodeFromFlow(e, r);
      if (!l) return !1;
      ((this._hasFlowComponent = !0), (i = l));
    }
    if (r) i && ((i.parent = r), r.children || (r.children = []), r.children.push(i));
    else {
      if (!i) {
    ...
    const n = i ?? r,
      s = a ? Array.from(e.children) : sl(e);
    for (const l of s) await this.addToTree(l, n);
    return i !== void 0;
  }
  generateNodeFromFiber(e, r) {
    const o = Lo(e) ? tr(e) : void 0,
      a = r?.children.length ?? 0,
      i = this;
    return {
      node: e,
      parent: r,
      ...
      get uuid() {
        ...
        if (e.alternate && ct.has(e.alternate)) return ct.get(e.alternate);
        const s = zi();
        return (ct.set(e, s), s);
      },
      get name() {
      ...
      get previousSibling() {
        if (a !== 0) return r?.children[a - 1];
      },
      get nextSibling() {
        if (!(r === void 0 || a === r.children.length - 1)) return r.children[a + 1];
      },
      get path() {
        return ha(this);
      },
  ...
  generateNodeFromFlow(e, r) {
    const o = It(e);
    if (!o) return;
    const a = r?.children.length ?? 0,
      i = this.flowCustomComponentData,
      n = this.componentDragDropApiInfosMap;
    return {
      node: o,
      parent: r,
      element: e,
      ...
      get customComponentData() {
        if (i[o.uiId]) return i[o.uiId].allComponentsInfoForCustomComponentSupport[o.nodeId];
      },
      get componentDragDropApiInfo() {
        if (!n[o.uiId]) return;
        const l = n[o.uiId];
        if (l[o.nodeId]) return l[o.nodeId];
      },
    };
  }
  async addOverlayContentToTreeIfExists(e) {
    ...
    if (o) for (const a of Array.from(r.children)) await this.addToTree(a, this.getNodeOfElement(r));
  }
  hasFlowComponents() {
  ...
  findByTreePath(e) {
    if (e) return this.allNodesFlat.find(r => r.path === e);
  }
  isAborted() {
    return this.aborted;
  }
...
function ha(t) {
  ...
  let e = 0;
  for (let r = 0; r < t.siblingIndex + 1; r++) t.parent.children[r].name === t.name && e++;
...
const Br = t => {
  if (_.isActivationShortcut() && _.getToolbarExpandMode() !== 'never')
    if (t.key === 'Shift' && !t.ctrlKey && !t.altKey && !t.metaKey) ma = !0;
    else if (ma && t.shiftKey && (t.key === 'Control' || t.key === 'Meta')) {
      if ((dt++, dt === 2))
        return (
          f.activeMode === 'play'
            ? f.lastNonPlayMode === void 0
              ? f.setActiveMode('edit', !0)
              : f.setActiveMode(f.lastNonPlayMode, !0)
            : f.setActiveMode('play', !0),
          pd(),
          (dt = 0),
          !0
        );
...
function ya(t) {
  if ((t.ctrlKey || t.metaKey) && t.key === 'c' && !t.shiftKey) {
    ...
    let r;
    if (
      (typeof e?.getSelection == 'function' ? (r = e?.getSelection()) : (r = document.getSelection() ?? void 0), r && r.rangeCount === 1)
    ) {
      const a = r.getRangeAt(0).commonAncestorContainer;
      if (a.nodeType === Node.TEXT_NODE) return ke(a);
    }
  }
  return !1;
}
...
const wa = t => {
    ...
    if (!e) return;
    const r = ud(e),
      o = e.localName === 'copilot-main',
      a = or(e, 'copilot-outline-panel') !== null,
      i = or(e, 'copilot-toolbar') !== null;
    ...
    if (ya(t)) n = !1;
      ...
      vd(t) && f.activeMode === 'edit'
        ? (y.emit('delete-selected', {}), (s = !0))
        : (t.ctrlKey || t.metaKey) && t.key === 'd' && f.activeMode === 'edit'
          ? (y.emit('duplicate-selected', {}), (s = !0))
          : (t.ctrlKey || t.metaKey) && t.key === 'b'
            ? (y.emit('show-selected-in-ide', { attach: t.shiftKey }), (s = !0))
            : (t.ctrlKey || t.metaKey) && t.key === 'z' && hd()
              ? (y.emit('undoRedo', { undo: !t.shiftKey }), (s = !0))
              : ya(t) || y.emit('keyboard-event', { event: t });
...
function fd(t) {
  ...
  if (Xo(t)) return !0;
  const r = bi(e);
  for (const o of r) if (Xo(o)) return !0;
  return !1;
}
const oe = cd(),
  Ut = '⇧',
  ...
  Wi = () => {
    gd()
      .then(t => f.setUserInfo(t))
      .catch(t => qe('Failed to load userInfo', t));
  },
...
var bd = Object.defineProperty,
  ...
  be = (t, e, r, o) => {
    for (var a = o > 1 ? void 0 : o ? md(e, r) : e, i = t.length - 1, n; i >= 0; i--) (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
...
let de = class extends Be {
  constructor() {
    (super(...arguments),
      ...
      (this.checked = !1),
      (this.disabled = !1),
      (this.documentMouseDownEventClickListener = t => {
        const e = mi([this]);
        gi(e, t.x, t.y) ||
          (this.buttonElement.blur(), document.removeEventListener('mousedown', this.documentMouseDownEventClickListener, { capture: !0 }));
      }));
  }
  createRenderRoot() {
    return this;
...
be([po('button[role="switch"]')], de.prototype, 'buttonElement', 2);
be([at({ type: String })], de.prototype, 'ariaLabel', 2);
be([at({ type: String })], de.prototype, 'ariaLabelledby', 2);
be([at({ type: String })], de.prototype, 'ariaDescribedby', 2);
be([at({ type: String })], de.prototype, 'description', 2);
be([at({ reflect: !0, type: Boolean })], de.prototype, 'checked', 2);
be([at({ reflect: !0, type: Boolean })], de.prototype, 'disabled', 2);
de = be([Oi('copilot-toggle-button')], de);
var yd = Object.defineProperty,
  wd = Object.getOwnPropertyDescriptor,
  bo = (t, e, r, o) => {
    for (var a = o > 1 ? void 0 : o ? wd(e, r) : e, i = t.length - 1, n; i >= 0; i--) (n = t[i]) && (a = (o ? n(e, r, a) : n(a)) || a);
...
let nr = class extends cc {
  constructor() {
    (super(...arguments),
      (this.removers = []),
      (this.initialized = !1),
      (this.overlayListener = t => {
        const { overlay: e } = t.detail,
          r = e?.owner,
          o = r instanceof HTMLElement && (r.hasAttribute('modal') || r.modal === !0);
        if (r && ke(r) && o) {
          const i = e;
      ...
      (this.operationInProgressCursorUpdateDebounceFunc = td(this.toggleOperationInProgressAttr, 500)),
      (this.overlayOutsideClickListener = t => {
  ...
  connectedCallback() {
    (super.connectedCallback(),
      ...
      y.ensureConnectedTarget(),
      document.body.addEventListener('vaadin-overlay-open', this.overlayListener),
      this.init().catch(t => qe('Unable to initialize copilot', t)));
  }
  ...
  promoteToolbar() {
    this.toolbar &&
      (this.toolbar.hidePopover && typeof this.toolbar.hidePopover == 'function' && this.toolbar.hidePopover(),
      this.toolbar.showPopover && typeof this.toolbar.showPopover == 'function' && this.toolbar.showPopover());
  }
  async init() {
    if (this.initialized) return;
    (await window.Vaadin.copilot._machineState.initializer.promise,
      await import('./copilot-global-vars-later-BvgzsxWe.js'),
      await import('./copilot-init-step2-s-Z4876h.js'),
      hc(),
      (this.tabIndex = 0),
      window.addEventListener('keydown', Br),
      this.addEventListener('keydown', wa),
      y.onSend(this.handleSendEvent),
      this.removers.push(
      ...
      Kr.addOverlayOutsideClickEvent(),
      this.setCopilotThemeClass(),
      this.reaction(
        () => f.activeMode,
        () => {
          f.activeMode && O.saveCopilotActiveMode(f.activeMode, f.lastNonPlayMode === f.activeMode ? void 0 : f.lastNonPlayMode);
        },
      ),
      this.reaction(
        ...
        () => {
          f.sectionPanelDragging &&
            Array.from(this.shadowRoot.children)
              .filter(r => r.localName.endsWith('-overlay'))
              .forEach(r => {
                r.close && r.close();
              });
        },
      ...
      this.reaction(
        ...
        () => {
          f.operationWaitsHmrUpdate
            ...
            : (this.operationInProgressCursorUpdateDebounceFunc.clear(), this.toggleOperationInProgressAttr());
        },
      ),
      this.reaction(
        () => Oe.panels,
      ...
      this.reaction(
        ...
        async (e, r) => {
          ...
          (Oe.restorePanelsFromStorage(),
            (e !== 'play' || Array.from(Oe.getOpenPanelTags()).some(o => Fs(o))) && (Wi(), dc(), pc(), await nd()),
            this.ensureTopmostPopover());
        },
        { fireImmediately: !0 },
      ),
      ...
      O.getCopilotActiveMode() && f.setActiveMode(O.getCopilotActiveMode()),
      O.getCopilotLastNonPlayMode() && f.setLastNonPlayMode(O.getCopilotLastNonPlayMode()),
      this.removers.push(
        y.on('user-select', e => {
  ...
  disconnectedCallback() {
    (super.disconnectedCallback(),
      window.removeEventListener('keydown', Br),
      this.removeEventListener('keydown', wa),
      y.offSend(this.handleSendEvent),
      this.removers.forEach(t => t()),
      ...
      Kr.removeOverlayOutsideClickEvent(),
      document.documentElement.removeEventListener('vaadin-overlay-outside-click', this.overlayOutsideClickListener),
      document.body.removeEventListener('vaadin-overlay-open', this.overlayListener));
  }
  handleSendEvent(t) {
    const e = t.detail.command,
      r = t.detail.data;
    re(e, r);
  }
  render() {
  ...
  detectAppTheme() {
    (Mo('lumo') ? f.setAppTheme('lumo') : Mo('aura') ? f.setAppTheme('aura') : f.setAppTheme(null),
      mr(`${ot}set-app-theme`, { theme: f.appTheme }, () => {}));
  }
  setCopilotSizeClass() {
  ...
  setCopilotThemeClass() {
    ...
    t === 'system'
      ? (this.classList.toggle('dark', this.prefersDarkMediaQuery.matches),
        this.prefersDarkMediaQuery.addEventListener('change', this.prefersDarkEventListener))
      : t === 'dark'
        ? (this.classList.toggle('dark', !0), this.prefersDarkMediaQuery.removeEventListener('change', this.prefersDarkEventListener))
        : (this.classList.toggle('dark', !1), this.prefersDarkMediaQuery.removeEventListener('change', this.prefersDarkEventListener));
  }
};
bo([po('copilot-toolbar')], nr.prototype, 'toolbar', 2);
bo([po('copilot-panel-manager')], nr.prototype, 'panelManager', 2);
nr = bo([Oi('copilot-main')], nr);
const xd = window.Vaadin,
  Sd = {
    init(t) {
      fi(
...
function kd(t, e, r = {}) {
  ...
  for (const i of Od()) {
    ...
    if (n) {
      (o.className &&
        n.props?.className &&
        ((n.props.className = `${String(n.props.className)} ${String(o.className)}`), delete o.className),
        (n.props = { ...n.props, ...o }));
      for (const [s, l] of Object.entries(n.props)) l === void 0 && delete n.props[s];
      return n;
    }
  }
...
function Ed(t) {
  if (Object.keys(t.styles).length === 0) return {};
  const e = {};
  return (
    Object.keys(t.styles).forEach(r => {
      const o = t.styles[r];
...
function Xi(t, e) {
  const r = [];
  for (const o of t.children) e(o) && r.push(o);
  for (const o of t.children) r.push(...Xi(o, e));
  return r;
}
function np(t, e, r) {
  return Xi(t, r)
