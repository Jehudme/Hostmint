...
var I = Object.defineProperty,
  ...
  u = (e, a, n, o) => {
    for (var s = o > 1 ? void 0 : o ? V(a, n) : a, c = e.length - 1, d; c >= 0; c--) (d = e[c]) && (s = (o ? d(a, n, s) : d(s)) || s);
...
let p = class extends w {
  ...
  connectedCallback() {
    (super.connectedCallback(),
      ...
      this.reaction(
        ...
        () => {
          if (!r.projectInfoEntries) return;
          let e = [...r.projectInfoEntries, { name: 'Development Workflow', value: '' }];
  ...
  renderRow(e) {
    ...
    const a = e.name === 'IDE Plugin' && e.value === !0 && r.idePluginState?.ide ? r.idePluginState.ide : e.value,
      n = this.getIcon(e.name, a),
      o = this.getIconColor(e.name),
      s = this.getTextColor(e);
    return i`
  ...
  renderRowValue(e) {
    return e.name === 'Vaadin Employee' && e.value === !0
      ? i`
  ...
  renderVaadinRowMore() {
    ...
    return i`
      ${
        r.projectVersionReleaseNoteInfo && r.projectVersionReleaseNoteInfo.url
          ? i`<a
  ...
  renderDevelopmentWorkflowButton() {
    ...
    return (
      e.status === 'success'
        ? ((a = 'text-teal-11'), (o = 'IDE Plugin & Java Hotswap'))
        : e.status === 'warning'
          ? ((a = 'text-amber-11'), (n = t.arrowUploadReady), (o = 'Improve'))
          : e.status === 'error' && ((a = 'text-ruby-11'), (n = t.handyman), (o = 'Fix')),
      i`
      <div class="flex gap-2 py-2">
        <dt class="flex gap-2">
  ...
  getIcon(e, a) {
    switch (e) {
      case 'Browser': {
        ...
        return n.includes('chrome') && !n.includes('edg')
          ? t.chrome
          : n.includes('firefox')
            ? t.firefox
      ...
      case 'IDE Plugin':
        return typeof a != 'string'
          ? t.developerModeTv
          : a.toLowerCase() === 'intellij'
            ? t.intelliJ
            : a.toLowerCase() === 'vscode'
              ? t.vsCode
              : a.toLowerCase() === 'eclipse'
                ? t.eclipse
                : t.developerModeTv;
      default:
        return null;
...
u([h()], p.prototype, 'sortedEntries', 2);
p = u([v('copilot-info-panel')], p);
...
function S(e, a) {
  let n;
  return (
    e === !0 ? (n = 'text-teal-11') : e === 'partial' ? (n = 'text-amber-11') : (n = 'text-ruby-11'),
    i`<span class="${n}">${a}</span>`
  );
}
export { f as Actions, p as CopilotInfoPanel };
