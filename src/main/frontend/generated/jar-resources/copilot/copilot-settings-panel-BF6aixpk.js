...
const g = x(A),
  m = window.Vaadin.copilot.tree;
if (!m) throw new Error('Tried to access copilot tree before it was initialized.');
var I = Object.defineProperty,
  E = Object.getOwnPropertyDescriptor,
  c = (s, i, d, p) => {
    for (var e = p > 1 ? void 0 : p ? E(i, d) : i, r = s.length - 1, v; r >= 0; r--) (v = s[r]) && (e = (p ? v(i, d, e) : v(e)) || e);
...
let n = class extends k {
  constructor() {
    (super(...arguments),
      (this.selectedTab = 0),
      (this.activationShortcutEnabled = a.isActivationShortcut()),
      (this.aiUsage = a.isAIUsageAllowed()),
      (this.aiProvider = a.getAIProvider()),
      (this.hideCopilotRequestOngoing = !1),
  ...
  renderKbd(s) {
    const i = s
      .replace(/<kbd([^>]*)class="([^"]*)"/, '<kbd$1class="$2 font-sans ms-auto"')
      .replace(/<kbd(?![^>]*class=)/, '<kbd class="font-sans ms-auto"');
    return y(i);
  }
  render() {
    return o`
  ...
  renderGeneralTab() {
    const s = a.getSelectedSize(),
      i = a.getSelectedTheme(),
      d = a.getToolbarExpandMode(),
      p = a.getBadgePositionMode();
    return o`
      <div class="border-dashed flex flex-col flex-grow divide-y pb-4 pt-0.5 px-4" part="general-tab-container">
        ...
        <div class="flex gap-2 items-start justify-between py-2">
          ...
          <vaadin-select
            ...
            .value="${i}"
            @change="${e => {
              a.setSelectedTheme(e.target.value);
            }}"></vaadin-select>
        </div>
        <div class="flex gap-2 items-start justify-between py-2">
          ...
          <vaadin-select
            ...
            @change="${e => {
              ...
              (a.setToolbarExpandMode(e.target.value),
        ...
        <div class="flex gap-2 items-start justify-between py-2">
          ...
          <vaadin-select
            ...
            @change="${e => {
              ...
              (a.setBadgePositionMode(e.target.value),
      ...
      <vaadin-confirm-dialog
        ...
        continue?
        ${
          this.hideCopilotRequestOngoing
            ? o`
  ...
  renderAiTab() {
    ...
    return o`<div class="border-dashed flex flex-col divide-y px-4 py-0.5">
      ...
      ${
        s
          ? o`<div class="flex gap-2 items-start justify-between py-2">
  ...
  onDisableConfirm() {
    ((this.hideCopilotRequestOngoing = !0),
      w(`${S}hide-copilot`, {}, s => {
        C(s.data, {}) || ((this.hideCopilotRequestOngoing = !1), window.location.reload());
      }));
  }
};
c([b()], n.prototype, 'selectedTab', 2);
c([b()], n.prototype, 'activationShortcutEnabled', 2);
c([b()], n.prototype, 'aiUsage', 2);
c([b()], n.prototype, 'aiProvider', 2);
c([b()], n.prototype, 'hideCopilotRequestOngoing', 2);
c([b()], n.prototype, 'hideCopilotDialogVisible', 2);
n = c([T('copilot-settings-panel')], n);
const D = {
    header: 'Settings',
    tag: f.SETTINGS,
  },
...
export { n as CopilotSettingsPanel, D as panelConfig };
