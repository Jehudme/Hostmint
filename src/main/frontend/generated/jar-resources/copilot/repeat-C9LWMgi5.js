  ...
  return (
    x ||
      ...
      (h = function () {
        ...
        for (var c = document.activeElement, f = [], d = 0; d < a.rangeCount; d++) f.push(a.getRangeAt(d));
  ...
  function r(l, t) {
    ...
    try {
      ((y = a()),
        ...
        e.addEventListener('copy', function (s) {
          if ((s.stopPropagation(), t.format))
            ...
            } else (s.clipboardData.clearData(), s.clipboardData.setData(t.format, l));
      ...
      try {
        ...
        (i && console.error('unable to copy using clipboardData: ', g),
          i && console.error('falling back to prompt'),
          (p = d('message' in t ? t.message : f)),
          window.prompt(p, l));
      }
    } finally {
    ...
    class extends S {
      ...
      update(a, [c, f, d]) {
        ...
        for (; o <= e && n <= u; )
          ...
          else if ((y === void 0 && ((y = T(t, n, u)), (m = T(i, o, e))), y.has(i[o])))
            if (y.has(i[e])) {
              const s = m.get(t[n]),
                g = s !== void 0 ? r[s] : null;
              if (g === null) {
