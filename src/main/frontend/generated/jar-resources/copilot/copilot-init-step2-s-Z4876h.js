...
const Co = {
  ...
  cancel(t) {
    const e = t - Li;
    if (e >= 0) {
      if (!Ue[e]) throw new Error(`invalid async handle: ${t}`);
      Ue[e] = null;
    }
  },
};
...
class un extends To {
   ...
   */
  runRenderer() {
    this.element[zt] = Tt.debounce(this.element[zt], Co, () => {
...
var Po = Object.defineProperty,
  ...
  hn = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? _o(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = (n ? a(e, r, i) : a(i)) || i);
    return (n && i && Po(e, r, i), i);
  };
let xt = class extends Mt {
  constructor() {
    (super(...arguments),
      (this.panelHeaderUpdated = 0),
      ...
      (this.windowResizeListener = async () => {
        await Promise.all(
          this.getOpenPanelContainerDialogs().map(async t => {
            ...
            (t.setAttribute('top', `${o.top}`),
              t.setAttribute('left', `${o.left}`),
  ...
  connectedCallback() {
    (super.connectedCallback(),
        ...
        () => {
          Array.from(this.querySelectorAll('vaadin-dialog[panel-container]')).forEach(t => {
            ...
            requestAnimationFrame(() => {
              t.toggleAttribute('hiding-while-drag-and-drop', D.operationInProgress === Di.DragAndDrop && !e && !this.hasDropTarget(t));
            });
          });
        },
      ),
      this.reaction(
        ...
        () => {
          const t = M.getAttentionRequiredPanelConfiguration(),
            e = this.getDialogByPanelTag(t?.tag);
      ...
      this.reaction(
        () => [M.panels, M.panelStackingOrder, M.getOpenPanelTags().size],
        () => {
          const t = M.panels.filter(r => M.isOpenedPanel(r.tag)),
            e = M.panelStackingOrder;
          this.openedPanelConfigurationsSorted = t.sort((r, n) => {
            const i = e.indexOf(r.tag),
              o = e.indexOf(n.tag);
            return i - o;
          });
        },
  ...
  disconnectedCallback() {
    (super.disconnectedCallback(),
      ...
      this.observeDisposer && this.observeDisposer());
  }
  createRenderRoot() {
    return this;
  }
    ...
    return C`
      ${rt(
        ...
        t => C`<vaadin-dialog
            ...
            @resize="${e => {
              const { top: r, left: n, width: i, height: o } = e.detail,
                a = e.currentTarget,
                d = Number.parseFloat(i),
              ...
              (a.setAttribute('top', `${s.top}`),
                a.setAttribute('left', `${s.left}`),
                a.setAttribute('width', `${s.width}`),
                a.setAttribute('height', `${s.height}`),
                M.updatePanel(t.tag, {
                  position: s,
                }));
            }}"
            @dragged="${e => {
              ...
              (n.setAttribute('top', `${a.top}`),
                n.setAttribute('left', `${a.left}`),
                M.updatePanel(r.tag, {
                  position: a,
                }));
            }}"
            ...
            @opened-changed="${e => {
              ...
              r &&
                (M.moveStackingOrderToTop(t.tag),
                (n.querySelector(t.tag)?.requestLayoutUpdate() ?? Promise.resolve()).finally(() => {
                  setTimeout(() => {
              ...
              if (!i) return;
              const o = i.getButtonId(t),
                a = i.querySelector(`vaadin-button#${o}`);
            ...
            ${Ft(
              () => C`
                <h2 class="font-bold me-auto my-0 text-xs truncate uppercase draggable" id="${t.tag}-title">
                  ...
                  ${
                    t.experimental
                      ? C`<vaadin-icon slot="suffix" .svg="${ee.experiment}"></vaadin-icon>
                        <vaadin-tooltip slot="tooltip" text="Experimental feature"></vaadin-tooltip>`
                      : De
                  }
                </h2>
            ...
            ${kt(() => C`<div class="h-full w-full">${Wt(`<${t.tag}></${t.tag}>`)}</div>`, [])}
            ${
              t.footerActionsTag
                ? Vt(
                    () => C`<div>
  ...
  getOpenPanelContainerDialogs() {
    const t = Array.from(this.querySelectorAll('vaadin-dialog[panel-container][opened]')),
      e = M.panelStackingOrder;
    return (
      t.sort((r, n) => {
        const i = r.dataset.panelTag,
          o = n.dataset.panelTag;
  ...
  getViewportAdjustedPosition(t) {
    const e = this.getViewportPaddingPx(),
      r = Number.isFinite(t.width) ? t.width : 0,
      n = Number.isFinite(t.height) ? t.height : 0;
    let i = Number.isFinite(t.top) ? t.top : 0,
      o = Number.isFinite(t.left) ? t.left : 0;
    const a = o + r,
      d = i + n;
    let c = 0,
      s = 0;
    return (
      o < 0 ? (c = -o) : a > window.innerWidth - e && (c = window.innerWidth - e - a),
      i < 0 ? (s = -i) : d > window.innerHeight - e && (s = window.innerHeight - e - d),
      (o += c),
      (i += s),
      { top: i, left: o, width: r, height: n }
    );
  }
...
hn([ve()], xt.prototype, 'panelHeaderUpdated', 2);
hn([ve()], xt.prototype, 'openedPanelConfigurationsSorted', 2);
xt = hn([Le('copilot-panel-manager')], xt);
const Jr = window.Vaadin.copilot.customComponentHandler;
if (!Jr) throw new Error('Tried to access custom component handler before it was initialized.');
function Lo(t) {
  D.setOperationWaitsHmrUpdate(t, 3e4);
}
X.on('undoRedo', t => {
  const r = { files: Mo(t), uiId: so() },
    n = t.detail.undo ? 'copilot-plugin-undo' : 'copilot-plugin-redo',
    i = t.detail.undo ? 'undo' : 'redo';
  (ln(i),
    Lo(Di.RedoUndo),
    Ai(n, r, o => {
      if (!o.data.performed) {
...
function Mo(t) {
  if (t.detail.files) return t.detail.files;
  const e = Jr.getActiveDrillDownContext();
  if (e) {
    const r = Jr.getCustomComponentInfo(e);
    if (r) return new Array(r.customComponentFilePath);
  }
  return lo();
}
var No = Object.getOwnPropertyDescriptor,
  Ho = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? No(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = a(i) || i);
    return i;
  };
let Tn = class extends Mt {
  ...
  connectedCallback() {
    (super.connectedCallback(),
      this.classList.add('end-2', 'fixed', 'top-2', 'z-100'),
      X.on('show-notification', t => {
      ...
      <div
        ...
        <div
          ...
          <div class="flex flex-col flex-1">
            ...
            ${
              t.dismissId
                ? C` <hr class="border-b border-e-0 border-s-0 border-t-0 mx-0 my-3 w-full" />
                  <vaadin-checkbox
...
Tn = Ho([Le('copilot-notifications-container')], Tn);
function ko(t) {
...
fo(() => {
  ...
  t.addStateChangeListener && typeof t.addStateChangeListener == 'function'
    ? t.addStateChangeListener((e, r) => {
...
X.on('copilot-early-project-state', t => {
  (K.setSpringSecurityEnabled(t.detail.springSecurityEnabled),
    K.setSpringJpaDataEnabled(t.detail.springJpaDataEnabled),
    K.setSpringJpaDatasourceInitialization(t.detail.springJpaDatasourceInitialization),
    K.setSupportsHilla(t.detail.supportsHilla),
    K.setSpringApplication(t.detail.springApplication),
    K.setUrlPrefix(t.detail.urlPrefix),
    K.setServerVersions(t.detail.serverVersions),
    K.setJdkInfo(t.detail.jdkInfo),
    cn() === 'success' && ln('hotswap-active', { value: po() }),
    t.preventDefault());
});
...
var Fo = Object.defineProperty,
  ...
  Ni = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? Vo(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = (n ? a(e, r, i) : a(i)) || i);
    return (n && i && Fo(e, r, i), i);
  };
let Kr = class extends Nt {
  constructor() {
    (super(...arguments),
      (this.rememberChoice = !1),
      (this.opened = !1),
      (this.handleESC = t => {
...
Ni([Te()], Kr.prototype, 'opened', 2);
Kr = Ni([Le('copilot-ai-usage-confirmation-dialog')], Kr);
var qo = Object.defineProperty,
  Bo = Object.getOwnPropertyDescriptor,
  Ve = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? Bo(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = (n ? a(e, r, i) : a(i)) || i);
...
let _e = class extends Nt {
  constructor() {
    (super(...arguments),
      ...
      (this.eventListener = t => {
        ((this.exceptionReport = t.detail),
          (this.selectedItems = this.exceptionReport.items.map((e, r) => r)),
          (this.visibleItemIndex = 0),
          (this.searchInputValue = void 0),
          (this.dialogOpened = this.exceptionReport !== void 0));
      }));
  }
  connectedCallback() {
  ...
  render() {
    let t = '';
    return (
      this.exceptionReport && this.exceptionReport.items.length > 0 && (t = this.exceptionReport.items[this.visibleItemIndex].content),
      C` <vaadin-dialog
                  ...
                  (e, r) => C` <vaadin-item>
                      <input
                        ...
                        @change="${n => {
                          ...
                          if (i.checked) (o.push(r), (this.selectedItems = [...this.selectedItems]));
                          else {
  ...
  getIssueBodyNotEncoded() {
    ...
    const t = this.exceptionReport.items
      .filter((e, r) => this.selectedItems.indexOf(r) !== -1)
      .map(e => {
        let r = '```';
        return (
          e.name.includes('.java') && (r = `${r}java`),
          `## ${e.name} 
...
`)}`;
  ...
  submitErrorToGithub() {
    ...
    if (!t) return;
    const e = encodeURIComponent(t.title ?? 'Bug report '),
      r = this.getIssueBodyNotEncoded();
    if (!r) return;
...
Ve([ve()], _e.prototype, 'exceptionReport', 2);
Ve([ve()], _e.prototype, 'dialogOpened', 2);
Ve([ve()], _e.prototype, 'visibleItemIndex', 2);
Ve([ve()], _e.prototype, 'versions', 2);
Ve([ve()], _e.prototype, 'selectedItems', 2);
Ve([ve()], _e.prototype, 'searchInputValue', 2);
_e = Ve([Le('copilot-report-exception-dialog')], _e);
let pt;
X.on('copilot-project-compilation-error', t => {
  if (t.detail.error) {
    let e;
    if (t.detail.files && t.detail.files.length > 0) {
      const r = D.idePluginState?.supportedActions?.includes('undo')
        ? C`
            <vaadin-button
              @click="${n => {
      ...
      e = Ht(C`
        ...
        ${r}
      `);
    } else e = 'Project contains one or more compilation errors.';
    pt = Pe({
  ...
  } else (pt && Pi(pt), (pt = void 0));
});
var jo = Object.defineProperty,
  Zo = Object.getOwnPropertyDescriptor,
  Hi = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? Zo(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = (n ? a(e, r, i) : a(i)) || i);
...
Hi([Te({ type: Function })], Qr.prototype, 'text', 2);
Qr = Hi([Le('copilot-copy')], Qr);
var Go = {
  202: 'Accepted',
  502: 'Bad Gateway',
  400: 'Bad Request',
...
function Uo(t) {
  var e = Go[t.toString()];
  if (!e) throw new Error('Status code does not exist: ' + t);
  return e;
}
function ki(t) {
...
X.on('endpoint-request', t => {
  const e = t.detail,
    r = ki(e);
  delete e.id;
  const n = Object.values(e.params),
    i = n.map(Ct).join(', ');
  X.emit('log', {
    id: r,
    type: se.INFORMATION,
...
X.on('endpoint-response', t => {
  ...
  const r = {},
    n = t.detail.status ?? 200;
  (n === 200
    ? ((r.details = `Response: ${Ct(e)}`),
      (r.expandedDetails = Ht(C`Response: <code class="codeblock"><copilot-copy></copilot-copy>${Ct(e)}</code>`)))
    : ((r.details = `Error: ${n} ${Uo(n)}`), (r.type = se.ERROR)),
    X.emit('update-log', {
      id: ki(t.detail),
      ...r,
    }));
...
var Xo = Object.defineProperty,
  ...
  Me = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? Wo(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = (n ? a(e, r, i) : a(i)) || i);
...
let ge = class extends Nt {
  constructor() {
    (super(...arguments),
      ...
      (this.linkText = void 0),
      (this.source = void 0),
      (this.javaSource = void 0),
      (this.node = void 0));
  }
  static get styles() {
    return [In(go), In(vo)];
  ...
  render() {
    if (this.iconHidden) {
      if (!this.linkHidden) return this.renderContent(this.renderAnchor());
  ...
  getFileName() {
    ...
    if (this.source && this.source.fileName) return bo(this.source.fileName);
...
Me([Te({ type: Boolean })], ge.prototype, 'iconHidden', 2);
Me([Te({ type: Boolean })], ge.prototype, 'linkHidden', 2);
Me([Te()], ge.prototype, 'tooltipText', 2);
Me([Te()], ge.prototype, 'linkText', 2);
Me([Te()], ge.prototype, 'source', 2);
Me([Te()], ge.prototype, 'javaSource', 2);
Me([Te()], ge.prototype, 'node', 2);
ge = Me([Le(ge.TAG)], ge);
/**!
 * Sortable 1.15.6
...
var Qo = '1.15.6';
function Se(t) {
  if (typeof window < 'u' && window.navigator) return !!(/* @__PURE__ */ navigator.userAgent.match(t));
}
var xe = Se(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
  dt = Se(/Edge/i),
  On = Se(/firefox/i),
  nt = Se(/safari/i) && !Se(/chrome/i) && !Se(/android/i),
  fn = Se(/iP(ad|od|hone)/i),
  Fi = Se(/chrome/i) && Se(/android/i),
  Vi = {
    capture: !1,
    passive: !1,
  };
...
function me(t, e, r, n) {
  if (t) {
    r = r || document;
    do {
      if ((e != null && (e[0] === '>' ? t.parentNode === r && Ot(t, e) : Ot(t, e))) || (n && t === r)) return t;
      if (t === r) break;
    } while ((t = qi(t)));
  }
  return null;
...
function z(t, e, r, n, i) {
  if (!(!t.getBoundingClientRect && t !== window)) {
    var o, a, d, c, s, l, u;
    if (
      (t !== window && t.parentNode && t !== ye()
        ? ((o = t.getBoundingClientRect()), (a = o.top), (d = o.left), (c = o.bottom), (s = o.right), (l = o.height), (u = o.width))
        : ((a = 0), (d = 0), (c = window.innerHeight), (s = window.innerWidth), (l = window.innerHeight), (u = window.innerWidth)),
      (e || r) && t !== window && ((i = i || t.parentNode), !xe))
    )
      do
        if (i && i.getBoundingClientRect && (S(i, 'transform') !== 'none' || (r && S(i, 'position') !== 'static'))) {
          var h = i.getBoundingClientRect();
          ((a -= h.top + parseInt(S(i, 'border-top-width'))),
            (d -= h.left + parseInt(S(i, 'border-left-width'))),
            (c = a + o.height),
            (s = d + o.width));
          break;
        }
...
function pn(t, e) {
  for (var r = t.lastElementChild; r && (r === $.ghost || S(r, 'display') === 'none' || (e && !Ot(r, e))); ) r = r.previousElementSibling;
  return r || null;
}
function fe(t, e) {
  var r = 0;
  if (!t || !t.parentNode) return -1;
  for (; (t = t.previousElementSibling); ) t.nodeName.toUpperCase() !== 'TEMPLATE' && t !== $.clone && (!e || Ot(t, e)) && r++;
  return r;
}
function Pn(t) {
  var e = 0,
  ...
  return (
    Array.from(t.children).forEach(function (i) {
      ...
      if (!(!me(i, e.draggable, t, !1) || i.animated || i === r)) {
        var s = z(i);
        ((n.left = Math.min((o = n.left) !== null && o !== void 0 ? o : 1 / 0, s.left)),
          (n.top = Math.min((a = n.top) !== null && a !== void 0 ? a : 1 / 0, s.top)),
          (n.right = Math.max((d = n.right) !== null && d !== void 0 ? d : -1 / 0, s.right)),
          (n.bottom = Math.max((c = n.bottom) !== null && c !== void 0 ? c : -1 / 0, s.bottom)));
      }
    }),
  ...
  return {
      ...
      (t.forEach(function (d) {
        ...
        (f && ((u.top -= f.f), (u.left -= f.e)),
          ...
          s.thisAnimationDuration &&
            Jt(h, u) &&
            !Jt(l, u) && // Make sure animatingRect is on line between toRect & fromRect
            (b.top - u.top) / (b.left - u.left) === (l.top - u.top) / (l.left - u.left) &&
            (c = oa(b, h, p, i.options)),
          Jt(u, l) || ((s.prevFromRect = l), (s.prevToRect = u), c || (c = i.options.animation), i.animate(s, b, u, c)),
          c &&
            ((o = !0),
            (a = Math.max(a, c)),
    ...
    animate: function (n, i, o, a) {
      if (a) {
        ...
        ((n.animatingX = !!l),
          (n.animatingY = !!u),
          S(n, 'transform', 'translate3d(' + l + 'px,' + u + 'px,0)'),
          (this.forRepaintDummy = ia(n)),
          S(n, 'transition', 'transform ' + a + 'ms' + (this.options.easing ? ' ' + this.options.easing : '')),
          S(n, 'transform', 'translate3d(0,0,0)'),
...
var Be = [],
  ...
  ut = {
    mount: function (e) {
      for (var r in Kt) Kt.hasOwnProperty(r) && !(r in e) && (e[r] = Kt[r]);
...
function aa(t) {
  ...
  if (((e = e || (r && r[le])), !!e)) {
    var f,
      I = e.options,
      _ = 'on' + n.charAt(0).toUpperCase() + n.substr(1);
    (window.CustomEvent && !xe && !dt
      ? (f = new CustomEvent(n, {
          bubbles: !0,
          cancelable: !0,
        }))
      : ((f = document.createEvent('Event')), f.initEvent(n, !0, !0)),
      (f.to = a || r),
      (f.from = d || r),
      (f.item = i || r),
      (f.clone = o),
...
var g,
  ...
  vt = fn,
  Mn = dt || xe ? 'cssFloat' : 'float',
  la = qt && !Fi && !fn && 'draggable' in document.createElement('div'),
  Xi = (function () {
    if (qt) {
      if (xe) return !1;
  ...
  Wi = function (e, r) {
    var n = S(e),
      i =
        parseInt(n.width) - parseInt(n.paddingLeft) - parseInt(n.paddingRight) - parseInt(n.borderLeftWidth) - parseInt(n.borderRightWidth),
      o = Ye(e, 0, r),
      a = Ye(e, 1, r),
      d = o && S(o),
      c = a && S(a),
      s = d && parseInt(d.marginLeft) + parseInt(d.marginRight) + z(o).width,
      l = c && parseInt(c.marginLeft) + parseInt(c.marginRight) + z(a).width;
  ...
  Yi = function (e) {
    function r(o, a) {
      return function (d, c, s, l) {
        ...
        if (o == null && (a || u)) return !0;
        if (o == null || o === !1) return !1;
        if (a && o === 'clone') return o;
        if (typeof o == 'function') return r(o(d, c, s, l), a)(d, c, s, l);
...
function $(t, e) {
  ...
  ((this.nativeDraggable = e.forceFallback ? !1 : la),
    this.nativeDraggable && (this.options.touchStartThreshold = 1),
    e.supportPointer ? H(t, 'pointerdown', this._onTapStart) : (H(t, 'mousedown', this._onTapStart), H(t, 'touchstart', this._onTapStart)),
...
$.prototype =
  /** @lends Sortable.prototype */
  {
    ...
    _onTapStart: function (e) {
      if (e.cancelable) {
        var r = this,
          ...
          c = (d || e).target,
          s = (e.target.shadowRoot && ((e.path && e.path[0]) || (e.composedPath && e.composedPath()[0]))) || c,
          l = i.filter;
        if (
          (Ea(n),
          !g &&
            ...
            !s.isContentEditable &&
            !(!this.nativeDraggable && nt && c && c.tagName.toUpperCase() === 'SELECT') &&
            ((c = me(c, i.draggable, n, !1)), !(c && c.animated) && wt !== c))
        ) {
        ...
        if (
          ...
          (c = function () {
            ...
            (i._disableDelayedDragEvents(),
              !On && i.nativeDraggable && (g.draggable = !0),
          ...
          H(d, 'touchmove', He),
          a.supportPointer
            ? (H(d, 'pointerup', i._onDrop), !this.nativeDraggable && H(d, 'pointercancel', i._onDrop))
            : (H(d, 'mouseup', i._onDrop), H(d, 'touchend', i._onDrop), H(d, 'touchcancel', i._onDrop)),
          On && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (g.draggable = !0)),
          ae('delayStart', this, {
            evt: e,
          }),
          ...
          (a.supportPointer
            ? (H(d, 'pointerup', i._disableDelayedDrag), H(d, 'pointercancel', i._disableDelayedDrag))
            : (H(d, 'mouseup', i._disableDelayedDrag), H(d, 'touchend', i._disableDelayedDrag), H(d, 'touchcancel', i._disableDelayedDrag)),
            H(d, 'mousemove', i._delayedDragTouchMoveHandler),
            H(d, 'touchmove', i._delayedDragTouchMoveHandler),
            a.supportPointer && H(d, 'pointermove', i._delayedDragTouchMoveHandler),
    ...
    _disableDelayedDragEvents: function () {
      ...
      (L(e, 'mouseup', this._disableDelayedDrag),
        L(e, 'touchend', this._disableDelayedDrag),
        L(e, 'touchcancel', this._disableDelayedDrag),
        L(e, 'pointerup', this._disableDelayedDrag),
        L(e, 'pointercancel', this._disableDelayedDrag),
        L(e, 'mousemove', this._delayedDragTouchMoveHandler),
        L(e, 'touchmove', this._delayedDragTouchMoveHandler),
        L(e, 'pointermove', this._delayedDragTouchMoveHandler));
    },
    _triggerDragStart: function (e, r) {
      ((r = r || (e.pointerType == 'touch' && e)),
        !this.nativeDraggable || r
          ...
          : (H(g, 'dragend', this), H(j, 'dragstart', this._onDragStart)));
      try {
        document.selection
          ? It(function () {
    ...
    _emulateDragOver: function () {
      if (pe) {
        ...
        for (
          var e = document.elementFromPoint(pe.clientX, pe.clientY), r = e;
          e && e.shadowRoot && ((e = e.shadowRoot.elementFromPoint(pe.clientX, pe.clientY)), e !== r);
        )
          r = e;
    ...
    _onTouchMove: function (e) {
      if (Ne) {
        var r = this.options,
          ...
          c = x && a && a.d,
          s = vt && te && Pn(te),
          l = (o.clientX - Ne.clientX + i.x) / (d || 1) + (s ? s[0] - tr[0] : 0) / (d || 1),
          u = (o.clientY - Ne.clientY + i.y) / (c || 1) + (s ? s[1] - tr[1] : 0) / (c || 1);
        if (!$.active && !Ze) {
    ...
    _appendGhost: function () {
      if (!x) {
        var e = this.options.fallbackOnBody ? document.body : j,
          ...
          n = this.options;
        if (vt) {
          for (te = e; S(te, 'position') === 'static' && S(te, 'transform') === 'none' && te !== document; ) te = te.parentNode;
          (te !== document.body && te !== document.documentElement
            ? (te === document && (te = ye()), (r.top += te.scrollTop), (r.left += te.scrollLeft))
            : (te = ye()),
            (tr = Pn(te)));
        }
        ((x = g.cloneNode(!0)),
          de(x, n.ghostClass, !1),
          de(x, n.fallbackClass, !0),
          de(x, n.dragClass, !0),
          S(x, 'transition', ''),
          S(x, 'transform', ''),
          ...
          S(x, 'height', r.height),
          S(x, 'opacity', '0.8'),
          S(x, 'position', vt ? 'absolute' : 'fixed'),
          S(x, 'zIndex', '100000'),
          S(x, 'pointerEvents', 'none'),
          ($.ghost = x),
          e.appendChild(x),
          S(x, 'transform-origin', (_n / parseInt(x.style.width)) * 100 + '% ' + (Ln / parseInt(x.style.height)) * 100 + '%'));
      }
    },
    _onDragStart: function (e, r) {
      ...
      (ae('setupClone', this),
        $.eventCanceled ||
          ...
          (Z.style['will-change'] = ''),
          this._hideClone(),
          de(Z, this.options.chosenClass, !1),
          ($.clone = Z)),
        (n.cloneId = It(function () {
          (ae('clone', n),
            !$.eventCanceled &&
              (n.options.removeCloneOnHide || j.insertBefore(Z, g),
              n._hideClone(),
              ne({
                sortable: n,
                name: 'clone',
        ...
        !r && de(g, o.dragClass, !0),
        r
          ? ((Dt = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
          : (L(document, 'mouseup', n._onDrop),
            L(document, 'touchend', n._onDrop),
            L(document, 'touchcancel', n._onDrop),
            i && ((i.effectAllowed = 'move'), o.setData && o.setData.call(n, i, g)),
            H(document, 'drop', n),
            S(g, 'transform', 'translateZ(0)')),
        (Ze = !0),
        (n._dragStartId = It(n._dragStarted.bind(n, r, e))),
        H(document, 'selectstart', n),
        (Qe = !0),
        window.getSelection().removeAllRanges(),
        nt && S(document.body, 'user-select', 'none'));
    },
    ...
    _onDragOver: function (e) {
      ...
      function k(R) {
        return (
          ...
          R &&
            (l ? s._hideClone() : s._showClone(b),
            b !== h && (de(g, Q ? Q.options.ghostClass : s.options.ghostClass, !1), de(g, d.ghostClass, !0)),
            Q !== b && b !== $.active ? (Q = b) : b === $.active && Q && (Q = null),
            h === b && (b._ignoreWhileAnimating = n),
            b.animateAll(function () {
              (I('dragOverAnimationComplete'), (b._ignoreWhileAnimating = null));
            }),
            b !== h && (h.animateAll(), (h._ignoreWhileAnimating = null))),
          ((n === g && !g.animated) || (n === r && !n.animated)) && (je = null),
          !d.dragoverBubble && !e.rootEl && n !== document && (g.parentNode[le]._isOutsideThisEl(e.target), !R && He(e)),
      ...
      if (
        (e.preventDefault !== void 0 && e.cancelable && e.preventDefault(), (n = me(n, d.draggable, r, !0)), I('dragOver'), $.eventCanceled)
      )
        return f;
      if (g.contains(e.target) || (n.animated && n.animatingX && n.animatingY) || b._ignoreWhileAnimating === n) return k(!1);
      if (
        ((Dt = !1),
        s &&
          !d.disabled &&
          (l ? u || (a = U !== j) : Q === this || ((this.lastPutMode = mt.checkPull(this, s, g, e)) && c.checkPut(this, s, g, e))))
      ) {
        ...
        if (!V || (ma(e, p, this) && !V.animated)) {
          ...
          var G = Ye(r, 0, d, !0);
          if (G === g) return k(!1);
          if (((n = G), (o = z(n)), bt(j, r, g, i, n, o, e, !1) !== !1)) return (_(), r.insertBefore(g, G), (U = r), A(), k(!0));
        } else if (n.parentNode === r) {
          o = z(n);
          var N = 0,
            q,
            T = g.parentNode !== r,
            J = !ca((g.animated && g.toRect) || i, (n.animated && n.toRect) || o, p),
            Re = p ? 'top' : 'left',
            he = An(n, 'top', 'top') || An(g, 'top', 'top'),
            Ie = he ? he.scrollTop : void 0;
          (je !== n && ((q = o[Re]), (st = !1), (gt = (!J && d.invertSwap) || T)),
            (N = ga(
              e,
              n,
              o,
          ...
          if (N !== 0) {
            var v = fe(g);
            do ((v -= N), (ce = U.children[v]));
            while (ce && (S(ce, 'display') === 'none' || ce === x));
          }
          if (N === 0 || ce === n) return k(!1);
          ((je = n), (at = N));
          ...
          if (E !== !1)
            return (
              ...
              setTimeout(fa, 30),
              _(),
              y && !m ? r.appendChild(g) : n.parentNode.insertBefore(g, y ? m : n),
              he && Zi(he, 0, Ie - he.scrollTop),
              (U = g.parentNode),
              q !== void 0 && !gt && (Rt = Math.abs(q - z(n)[Re])),
              A(),
              k(!0)
            );
        }
        if (r.contains(g)) return k(!1);
      }
      return !1;
    },
    ...
    _offMoveEvents: function () {
      (L(document, 'mousemove', this._onTouchMove),
        ...
        L(document, 'dragover', He),
        L(document, 'mousemove', He),
        L(document, 'touchmove', He));
    },
    _offUpEvents: function () {
      var e = this.el.ownerDocument;
      (L(e, 'mouseup', this._onDrop),
        L(e, 'touchend', this._onDrop),
        L(e, 'pointerup', this._onDrop),
        L(e, 'pointercancel', this._onDrop),
        L(e, 'touchcancel', this._onDrop),
        L(document, 'selectstart', this));
    },
    _onDrop: function (e) {
      var r = this.el,
        n = this.options;
      ...
      ((Ze = !1),
        ...
        tn(this.cloneId),
        tn(this._dragStartId),
        this.nativeDraggable && (L(document, 'drop', this), L(r, 'dragstart', this._onDragStart)),
        this._offMoveEvents(),
        this._offUpEvents(),
        nt && S(document.body, 'user-select', ''),
        S(g, 'transform', ''),
        e &&
          (Qe && (e.cancelable && e.preventDefault(), !n.dropBubble && e.stopPropagation()),
          x && x.parentNode && x.parentNode.removeChild(x),
          (j === U || (Q && Q.lastPutMode !== 'clone')) && Z && Z.parentNode && Z.parentNode.removeChild(Z),
          g &&
            (this.nativeDraggable && L(g, 'dragend', this),
            rr(g),
            (g.style['will-change'] = ''),
            Qe && !Ze && de(g, Q ? Q.options.ghostClass : this.options.ghostClass, !1),
            de(g, this.options.chosenClass, !1),
            ne({
              sortable: this,
              name: 'unchoose',
              toEl: U,
    ...
    destroy: function () {
      ...
      var e = this.el;
      ((e[le] = null),
        L(e, 'mousedown', this._onTapStart),
        L(e, 'touchstart', this._onTapStart),
        L(e, 'pointerdown', this._onTapStart),
        this.nativeDraggable && (L(e, 'dragover', this), L(e, 'dragenter', this)),
        Array.prototype.forEach.call(e.querySelectorAll('[draggable]'), function (r) {
          r.removeAttribute('draggable');
        }),
        this._onDrop(),
        this._disableDelayedDragEvents(),
        At.splice(At.indexOf(this.el), 1),
        (this.el = e = null));
    },
    _hideClone: function () {
      if (!Oe) {
    ...
    _showClone: function (e) {
      ...
      if (Oe) {
        ...
        (g.parentNode == j && !this.options.group.revertClone ? j.insertBefore(Z, g) : ke ? j.insertBefore(Z, ke) : j.appendChild(Z),
          this.options.group.revertClone && this.animate(g, Z),
          S(Z, 'display', ''),
          (Oe = !1));
      }
    },
...
function pa(t, e, r) {
  var n = z(Ye(r.el, 0, r.options, !0)),
    i = Ui(r.el, r.options, x),
    o = 10;
  return e
...
function ma(t, e, r) {
  var n = z(pn(r.el, r.options.draggable)),
    i = Ui(r.el, r.options, x),
    o = 10;
  return e
...
function ga(t, e, r, n, i, o, a, d) {
  var c = n ? t.clientY : t.clientX,
    s = n ? r.height : r.width,
    l = n ? r.top : r.left,
    u = n ? r.bottom : r.right,
    h = !1;
  if (!a) {
    if (d && Rt < s * i) {
      if ((!st && (at === 1 ? c > l + (s * o) / 2 : c < u - (s * o) / 2) && (st = !0), st)) h = !0;
      else if (at === 1 ? c < l + Rt : c > u - Rt) return -at;
    } else if (c > l + (s * (1 - i)) / 2 && c < u - (s * (1 - i)) / 2) return va(e);
  }
...
var or = ji(function (t, e, r, n) {
    if (e.scroll) {
      ...
      do {
        var p = h,
          ...
          he = p.scrollTop;
        p === c
          ? ((G = A < q && (J.overflowX === 'auto' || J.overflowX === 'scroll' || J.overflowX === 'visible')),
            (N = V < T && (J.overflowY === 'auto' || J.overflowY === 'scroll' || J.overflowY === 'visible')))
          : ((G = A < q && (J.overflowX === 'auto' || J.overflowX === 'scroll')),
            (N = V < T && (J.overflowY === 'auto' || J.overflowY === 'scroll')));
        var Ie = G && (Math.abs(k - i) <= a && Re + A < q) - (Math.abs(_ - i) <= a && !!Re),
          ce = N && (Math.abs(I - o) <= a && he + V < T) - (Math.abs(f - o) <= a && !!he);
        if (!Y[u]) for (var v = 0; v <= u; v++) Y[v] || (Y[v] = {});
        ((Y[u].vx != Ie || Y[u].vy != ce || Y[u].el !== p) &&
          ((Y[u].el = p),
          (Y[u].vx = Ie),
          (Y[u].vy = ce),
          ...
          (Ie != 0 || ce != 0) &&
            ...
            (Y[u].pid = setInterval(
              function () {
                ...
                var m = Y[this.layer].vy ? Y[this.layer].vy * d : 0,
                  y = Y[this.layer].vx ? Y[this.layer].vx * d : 0;
                (typeof l == 'function' && l.call($.dragged.parentNode[le], y, m, t, _t, Y[this.layer].el) !== 'continue') ||
                  Zi(Y[this.layer].el, y, m);
              }.bind({
                layer: u,
              }),
              24,
  ...
  Ki = function (e) {
    ...
    if (r) {
      var s = n || o;
      d();
      var l = r.changedTouches && r.changedTouches.length ? r.changedTouches[0] : r,
...
class wa {
  constructor() {
    ((this.handlers = []),
      (this.toolbarConnected = e => {
        ((this.toolbar = e),
          (this.reactionDisposer = ct(
      ...
      (this.toolbarDisconnected = () => {
        (this.activeExpandModeHandler && this.toolbar && this.activeExpandModeHandler.onDeactivate(this.toolbar),
      ...
      this.handlers.push(new an()),
      this.handlers.push(new Ra()),
      this.handlers.push(new Ia()),
      this.handlers.push(new Sa()),
      this.handlers.push(new $a()));
  }
}
class ht {
  constructor() {
  ...
  getIdleWidth(e) {
    const r = e.radioGroup,
      ...
      i = Number.parseFloat(getComputedStyle(r).getPropertyValue('--copilot-size-md')) * n;
    return n * 0.125 * 2 + i;
  }
  shrink() {
    this.toolbar &&
      (this.isDevToolsPopoverOpen ||
        (this.updateToolbarOpacity(!0),
        this.toolbar.setPlayModeIconProgress(0),
        (this.toolbar.radioGroup.style.width = `${this.getIdleWidth(this.toolbar)}px`),
        this.toolbar.updateToolbarTotalWidth(),
        this.toolbar.removeAttribute('modes-expanded')));
  }
...
const Lt = class Lt extends ht {
  constructor() {
    (super(...arguments),
      (this.lastDocumentMouseClientX = 0),
      (this.lastDocumentMouseClientY = 0),
      (this.ticking = !1),
      (this.handlePointerProximity = e => {
        this.toolbar &&
          ((this.lastDocumentMouseClientX = e.clientX),
          (this.lastDocumentMouseClientY = e.clientY),
          this.ticking ||
            (requestAnimationFrame(() => {
      ...
      (this.updateRadioButtonExpandAndStylingByPointerLocation = (e, r) => {
        ...
        const n = this.toolbar.radioGroup,
          i = n.style.width,
          o = this.toolbar.getBoundingClientRect(),
          a = Math.max(o.left - e, 0, e - o.right),
          d = Math.max(o.top - r, 0, r - o.bottom),
          c = Math.hypot(a, d),
          s = Math.max(0, 1 - c / Lt.PROXIMITY_RADIUS),
          l = Number.parseFloat(getComputedStyle(n).getPropertyValue('--copilot-toolbar-mode-width')),
          u = this.getIdleWidth(this.toolbar),
          h = on + (1 - on) * s;
        ((this.toolbar.style.opacity = h.toFixed(2)), this.toolbar.setPlayModeIconProgress(s));
        const p = u + (l - u) * s;
        ((n.style.width = `${p.toFixed(2)}px`),
          i !== n.style.width && this.toolbar.updateToolbarTotalWidth(),
          this.toolbar.toggleAttribute('modes-expanded', p === l));
      }));
  }
  onActivate(e) {
    ((this.toolbar = e),
      (this.activeModeReactionDisposer = ct(
        () => D.activeMode,
        () => {
          D.activeMode !== 'play' && this.toolbar
            ? (this.updateToolbarOpacity(!1), this.toolbar.expandRadioButtons())
  ...
  onDeactivate(e) {
    (document.removeEventListener('mousemove', this.handlePointerProximity),
      this.activeModeReactionDisposer && this.activeModeReactionDisposer());
  }
  devToolsPopoverOpenClosedChanged(e) {
    (super.devToolsPopoverOpenClosedChanged(e),
      this.isDevToolsPopoverOpen ||
        this.updateRadioButtonExpandAndStylingByPointerLocation(this.lastDocumentMouseClientX, this.lastDocumentMouseClientY));
  }
};
...
class Ra extends ht {
  ...
  onActivate(e) {
    ((this.toolbar = e),
      e.addEventListener('mouseover', this.handleMouseOverEvent),
      e.addEventListener('mouseleave', this.handleMouseLeaveEvent),
      (this.activeModeReactionDisposer = ct(
        () => D.activeMode,
        () => {
  ...
  onDeactivate(e) {
    ((this.toolbar = e),
      e.removeEventListener('mouseover', this.handleMouseOverEvent),
      e.removeEventListener('mouseleave', this.handleMouseLeaveEvent));
  }
  devToolsPopoverOpenClosedChanged(e) {
      ...
      (this.handleClick = e => {
        if (D.activeMode === 'play' && e.target && e.target instanceof HTMLElement) {
          ...
          n?.dataset.mode &&
            (n.dataset.mode === 'play'
              ? this.onPlayClickAction === 'expand'
                ? (this.toolbar?.expandRadioButtons(), (this.onPlayClickAction = 'collapse'))
                : (this.shrink(), (this.onPlayClickAction = 'expand'))
              : (this.toolbar?.expandRadioButtons(), (this.onPlayClickAction = 'collapse')));
        }
      }));
  }
...
class $a extends ht {
  constructor() {
    (super(...arguments),
      (this.handleMouseOverListener = e => {
  ...
  onActivate(e) {
    ((this.toolbar = e),
      D.setActiveMode('play', !0),
      e.addEventListener('mouseover', this.handleMouseOverListener),
      e.addEventListener('mouseleave', this.handleMouseLeaveListener),
      this.shrink());
  }
  onDeactivate(e) {
    this.toolbar &&
      (e.removeEventListener('mouseover', this.handleMouseOverListener),
      e.removeEventListener('mouseleave', this.handleMouseLeaveListener));
  }
}
var Ta = Object.defineProperty,
  xa = Object.getOwnPropertyDescriptor,
  qe = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? xa(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = (n ? a(e, r, i) : a(i)) || i);
    return (n && i && Ta(e, r, i), i);
  };
let ie = class extends Mt {
  constructor() {
    (super(...arguments),
      (this.sortableInitialized = !1),
      (this.modeRadioButtonItems = []),
      (this.devToolsDataLoading = !1),
      (this.devToolsDataLoaded = !1),
      (this.isDragging = !1),
      (this.dragPreparing = !1),
      (this.dragStartX = 0),
      (this.dragStartY = 0),
      (this.toolbarStartRight = 0),
      (this.toolbarStartTop = 0),
      (this.wasDraggedInLastInteraction = !1),
      (this.dragThreshold = 5),
      (this.expandModeHandler = new wa()),
      ...
      (this.handleMouseDown = t => {
        ...
        if (!e || !(t.target instanceof Node) || !e.contains(t.target)) return;
        ((this.dragPreparing = !0), (this.dragStartX = t.clientX), (this.dragStartY = t.clientY));
        const r = this.getBoundingClientRect();
        ((this.toolbarStartRight = window.innerWidth - r.right),
          (this.toolbarStartTop = r.top),
      ...
      (this.handleMouseMove = t => {
        ...
        const e = t.clientX - this.dragStartX,
          r = t.clientY - this.dragStartY,
          n = Math.sqrt(e * e + r * r);
        if (
          (this.dragPreparing &&
            n > this.dragThreshold &&
            ((this.isDragging = !0), (this.dragPreparing = !1), (this.style.transition = 'none')),
          this.isDragging)
        ) {
          let i = this.toolbarStartRight - e,
            o = this.toolbarStartTop + r;
      ...
      (this.expandRadioButtons = () => {
        ...
        const e = Number.parseFloat(getComputedStyle(this.radioGroup).getPropertyValue('--copilot-toolbar-mode-width'));
        ((this.radioGroup.style.width = `${e.toFixed(2)}px`),
          t !== this.radioGroup.style.width && this.updateToolbarTotalWidth(),
          this.toggleAttribute('modes-expanded', !0));
      }),
      (this.onSortEndEvent = (t, e, r) => {
        if (!(t.item instanceof HTMLElement)) return;
        const n = t.item.dataset.panelTag;
        if (!n || !M.getPanelByTag(n)) return;
  ...
  connectedCallback() {
    (super.connectedCallback(),
      (this.popover = 'manual'),
      this.setPlayModeIconProgress(1),
      (this.modeRadioButtonItems = Object.entries(Eo).map(([e, r]) => ({
        value: e,
        label: r.label,
        order: r.toolbarOrder,
        icon: r.toolbarIcon,
      }))),
      this.modeRadioButtonItems.sort((e, r) => e.order - r.order),
      this.classList.add(
        'backdrop-blur-sm',
        'bg-gray-1',
        'dark:bg-gray-5',
    ...
    (this.addEventListener('transitionstart', this.transitionStart),
      this.addEventListener('transitionend', this.transitionEnd),
      this.addEventListener('mousedown', this.handleMouseDown),
      this.addEventListener('click', this.handleClick, !0),
        ...
        () => {
          requestAnimationFrame(() => {
            ...
            if (this.hasAttribute('modes-expanded')) {
              const r = Number.parseFloat(getComputedStyle(e).getPropertyValue('--copilot-toolbar-mode-width'));
              e.style.width = `${r.toFixed(2)}px`;
            } else {
              const r = Number.parseFloat(getComputedStyle(document.documentElement).fontSize),
                n = Number.parseFloat(getComputedStyle(e).getPropertyValue('--copilot-size-md')) * r;
  ...
  disconnectedCallback() {
    (super.disconnectedCallback(),
      this.removeEventListener('transitionstart', this.transitionStart),
      this.removeEventListener('transitionend', this.transitionEnd),
      this.removeEventListener('mousedown', this.handleMouseDown),
      this.removeEventListener('click', this.handleClick, !0),
      document.removeEventListener('mousemove', this.handleMouseMove),
      document.removeEventListener('mouseup', this.handleMouseUp),
      window.removeEventListener('resize', this.handleWindowResize),
      this.expandModeHandler.toolbarDisconnected());
  }
  constrainToViewport(t = !1) {
    ...
    const e = this.getBoundingClientRect(),
      ...
      n = e.height;
    if (r === 0 || n === 0) return;
    let i = parseFloat(this.style.right),
      o = parseFloat(this.style.top || '0');
    const a = i,
      d = o;
    ...
    ((o = Math.min(o, s)),
      (this.style.right = `${i}px`),
      (this.style.top = `${o}px`),
      t && (i !== a || o !== d) && Yt.saveToolbarPosition(i, o));
  }
  createRenderRoot() {
    return this;
  }
  ...
  updated(t) {
    (super.updated(t),
      this.updateToolbarTotalWidth(),
      this.modePanelIconContainer !== null &&
        !this.sortableInitialized &&
        (new $(this.modePanelIconContainer, {
          animation: 150,
  ...
  updateToolbarTotalWidth() {
    ...
    const e = [...this.querySelectorAll('#mode-panel-icon-container, #mode-icon-container, #common-mode-panel-icon-container')].reduce(
      (r, n) => r + n.offsetWidth,
      0,
    );
  ...
  render() {
    ...
    return C`
      ...
      <div class="flex" id="common-mode-panel-icon-container">
        ...
        <vaadin-popover
          @opened-changed="${e => {
            (this.expandModeHandler.devToolsPopoverOpenClosedChanged(e.detail.value),
              e.detail.value &&
                !this.devToolsDataLoaded &&
                ((this.devToolsDataLoading = !0),
                import('./copilot-devtools-3a_R9e_q.js').then(() => {
  ...
  renderPanelList(t, e) {
    return C`
      ${rt(
        t
          .filter(r => r.experimental?.enabled() !== !1)
          .filter(r => r.toolbarOptions?.allowedModesWithOrder?.[e] !== void 0)
          .sort((r, n) => r.toolbarOptions.allowedModesWithOrder[e] - n.toolbarOptions.allowedModesWithOrder[e]),
        r => r.tag,
  ...
  renderModeButtonIcon(t) {
    return t.value !== 'play'
      ? C`<vaadin-icon .svg="${ee[t.icon]}"></vaadin-icon>`
      : C`
    ...
    return C`
      <vaadin-button
        ...
        @click=${r => {
          ...
          } else (M.attentionRequiredPanelTag === t.tag && M.clearAttention(), M.openPanel(t.tag));
        }}>
        ...
        ${
          M.attentionRequiredPanelTag === t.tag
            ? C`<span
                aria-hidden="true"
                class="absolute animate-ping bg-amber-11 end-0.5 rounded-full size-2 top-0.5"></span>
              <span
                aria-hidden="true"
                class="absolute bg-amber-11 border border-gray-1 dark:border-gray-5 box-border end-0.5 rounded-full size-2 top-0.5"></span>`
            : De
        }
      </vaadin-button>
    `;
  ...
  getOrderByTag(t) {
    ...
    return (
      [...t.querySelectorAll('[data-panel-tag]')].forEach((r, n) => {
...
qe([dn('#mode-panel-icon-container')], ie.prototype, 'modePanelIconContainer', 2);
qe([dn('#devtools-popover')], ie.prototype, 'devToolsPopover', 2);
qe([dn('vaadin-radio-group')], ie.prototype, 'radioGroup', 2);
qe([ve()], ie.prototype, 'modeRadioButtonItems', 2);
qe([ve()], ie.prototype, 'devToolsDataLoading', 2);
qe([ve()], ie.prototype, 'devToolsDataLoaded', 2);
ie = qe([Le('copilot-toolbar')], ie);
function Ca() {
  const t = [];
  D.userInfo?.vaadiner &&
    t.push({
  ...
  return (
    e.forEach(r => {
      r.name === 'Frontend Hotswap' &&
        (r.value === 'true'
          ? (r.booleanInfo = { ariaLabel: 'Enabled', text: 'Vite' })
          : r.value === 'false' && (r.booleanInfo = { ariaLabel: 'Disabled', text: 'Pre-Built Bundle' }));
    }),
    K.springSecurityEnabled && e.push({ name: 'Spring Security', value: 'true', booleanInfo: { ariaLabel: 'Enabled' } }),
    K.springJpaDataEnabled && e.push({ name: 'Spring Data JPA', value: 'true', booleanInfo: { ariaLabel: 'Enabled' } }),
    e.push(...Da()),
    Oa(e),
    e
  );
...
function Oa(t) {
  for (const e of t)
    e.value === 'true'
      ? ((e.value = !0),
        e.booleanInfo ? e.booleanInfo.ariaLabel || (e.booleanInfo.ariaLabel = 'Enabled') : (e.booleanInfo = { ariaLabel: 'Enabled' }))
      : e.value === 'false' &&
        ((e.value = !1),
        e.booleanInfo ? e.booleanInfo.ariaLabel || (e.booleanInfo.ariaLabel = 'Disabled') : (e.booleanInfo = { ariaLabel: 'Disabled' }));
}
function Da() {
  const t = [],
    e = cn(),
    r = Qi(D.idePluginState),
    n = eo(e);
  return (
    t.push({
      name: 'Java Hotswap',
...
function Aa(t) {
  ...
  if (!e) throw new Error('Unable to load project info entries');
  const i = e
    .map(o => ({ key: o.name, value: o.value }))
    .filter(o => o.key !== 'Live reload')
    .filter(o => !o.key.startsWith('Vaadin Emplo'))
    .filter(o => o.key !== 'Development Workflow')
    .map(o => {
      const { key: a } = o;
      let { value: d } = o;
      if (a === 'IDE Plugin') d = Qi(D.idePluginState) ?? 'false';
      else if (a === 'Java Hotswap') {
        const c = K.jdkInfo?.jrebel,
          s = cn();
        c && s === 'success' ? (d = 'JRebel is in use') : (d = eo(s));
      }
      return (
        a === 'Frontend Hotswap' && (d === 'true' || d === !0 ? (d = 'Vite') : (d === 'false' || d === !1) && (d = 'Pre-Built Bundle')),
        `${a}: ${d}`
      );
    }).join(`
`);
...
function Qi(t) {
  if ($t() !== 'success') return 'Not installed';
  if (t?.version) {
    let e = null;
    return (
      t?.ide &&
        (t?.ide === 'intellij' ? (e = 'IntelliJ') : t?.ide === 'vscode' ? (e = 'VS Code') : t?.ide === 'eclipse' && (e = 'Eclipse')),
      e ? `${t?.version} ${e}` : t?.version
    );
  }
...
ct(
  () => [K.serverVersions, K.clientVersions, D.userInfo, K.springSecurityEnabled, K.springJpaDataEnabled, K.jdkInfo, D.idePluginState],
  () => {
    const t = Ca();
...
var Pa = Object.getOwnPropertyDescriptor,
  _a = (t, e, r, n) => {
    for (var i = n > 1 ? void 0 : n ? Pa(e, r) : e, o = t.length - 1, a; o >= 0; o--) (a = t[o]) && (i = a(i) || i);
    return i;
  };
let Hn = class extends Mt {
  ...
  `),
      (this.tryAcquireLicense = () => {
        const t = 'vaadin-copilot',
          e = K.serverVersions.find(r => r.name === 'Vaadin')?.version;
...
Hn = _a([Le('copilot-login-check')], Hn);
var Et = { exports: {} },
  ar,
  kn;
function Bt() {
...
function ft() {
  return (
    Vn ||
      ((Vn = 1),
      (function (t, e) {
        const { MAX_SAFE_COMPONENT_LENGTH: r, MAX_SAFE_BUILD_LENGTH: n, MAX_LENGTH: i } = Bt(),
          o = jt();
        e = t.exports = {};
        const a = (e.re = []),
          d = (e.safeRe = []),
        ...
        const h = '[a-zA-Z0-9-]',
          ...
          b = I => {
            for (const [_, k] of p) I = I.split(`${_}*`).join(`${_}{0,${k}}`).split(`${_}+`).join(`${_}{1,${k}}`);
            return I;
          },
          f = (I, _, k) => {
            const A = b(_),
            ...
            (o(I, V, _),
              ...
              (c[V] = _),
              (s[V] = A),
              (a[V] = new RegExp(_, k ? 'g' : void 0)),
              (d[V] = new RegExp(A, k ? 'g' : void 0)));
          };
        (f('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
          f('NUMERICIDENTIFIERLOOSE', '\\d+'),
          f('NONNUMERICIDENTIFIER', `\\d*[a-zA-Z-]${h}*`),
          f('MAINVERSION', `(${c[l.NUMERICIDENTIFIER]})\\.(${c[l.NUMERICIDENTIFIER]})\\.(${c[l.NUMERICIDENTIFIER]})`),
          f('MAINVERSIONLOOSE', `(${c[l.NUMERICIDENTIFIERLOOSE]})\\.(${c[l.NUMERICIDENTIFIERLOOSE]})\\.(${c[l.NUMERICIDENTIFIERLOOSE]})`),
          f('PRERELEASEIDENTIFIER', `(?:${c[l.NONNUMERICIDENTIFIER]}|${c[l.NUMERICIDENTIFIER]})`),
          f('PRERELEASEIDENTIFIERLOOSE', `(?:${c[l.NONNUMERICIDENTIFIER]}|${c[l.NUMERICIDENTIFIERLOOSE]})`),
          f('PRERELEASE', `(?:-(${c[l.PRERELEASEIDENTIFIER]}(?:\\.${c[l.PRERELEASEIDENTIFIER]})*))`),
          f('PRERELEASELOOSE', `(?:-?(${c[l.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${c[l.PRERELEASEIDENTIFIERLOOSE]})*))`),
          f('BUILDIDENTIFIER', `${h}+`),
          f('BUILD', `(?:\\+(${c[l.BUILDIDENTIFIER]}(?:\\.${c[l.BUILDIDENTIFIER]})*))`),
          f('FULLPLAIN', `v?${c[l.MAINVERSION]}${c[l.PRERELEASE]}?${c[l.BUILD]}?`),
          f('FULL', `^${c[l.FULLPLAIN]}$`),
          f('LOOSEPLAIN', `[v=\\s]*${c[l.MAINVERSIONLOOSE]}${c[l.PRERELEASELOOSE]}?${c[l.BUILD]}?`),
          f('LOOSE', `^${c[l.LOOSEPLAIN]}$`),
          f('GTLT', '((?:<|>)?=?)'),
          f('XRANGEIDENTIFIERLOOSE', `${c[l.NUMERICIDENTIFIERLOOSE]}|x|X|\\*`),
          f('XRANGEIDENTIFIER', `${c[l.NUMERICIDENTIFIER]}|x|X|\\*`),
          f(
            'XRANGEPLAIN',
          ...
          f('XRANGE', `^${c[l.GTLT]}\\s*${c[l.XRANGEPLAIN]}$`),
          f('XRANGELOOSE', `^${c[l.GTLT]}\\s*${c[l.XRANGEPLAINLOOSE]}$`),
          f('COERCEPLAIN', `(^|[^\\d])(\\d{1,${r}})(?:\\.(\\d{1,${r}}))?(?:\\.(\\d{1,${r}}))?`),
          f('COERCE', `${c[l.COERCEPLAIN]}(?:$|[^\\d])`),
          f('COERCEFULL', c[l.COERCEPLAIN] + `(?:${c[l.PRERELEASE]})?(?:${c[l.BUILD]})?(?:$|[^\\d])`),
          f('COERCERTL', c[l.COERCE], !0),
          f('COERCERTLFULL', c[l.COERCEFULL], !0),
          f('LONETILDE', '(?:~>?)'),
          f('TILDETRIM', `(\\s*)${c[l.LONETILDE]}\\s+`, !0),
          (e.tildeTrimReplace = '$1~'),
          f('TILDE', `^${c[l.LONETILDE]}${c[l.XRANGEPLAIN]}$`),
          f('TILDELOOSE', `^${c[l.LONETILDE]}${c[l.XRANGEPLAINLOOSE]}$`),
          f('LONECARET', '(?:\\^)'),
          f('CARETTRIM', `(\\s*)${c[l.LONECARET]}\\s+`, !0),
          (e.caretTrimReplace = '$1^'),
          f('CARET', `^${c[l.LONECARET]}${c[l.XRANGEPLAIN]}$`),
          f('CARETLOOSE', `^${c[l.LONECARET]}${c[l.XRANGEPLAINLOOSE]}$`),
          f('COMPARATORLOOSE', `^${c[l.GTLT]}\\s*(${c[l.LOOSEPLAIN]})$|^$`),
          f('COMPARATOR', `^${c[l.GTLT]}\\s*(${c[l.FULLPLAIN]})$|^$`),
          f('COMPARATORTRIM', `(\\s*)${c[l.GTLT]}\\s*(${c[l.LOOSEPLAIN]}|${c[l.XRANGEPLAIN]})`, !0),
          (e.comparatorTrimReplace = '$1$2$3'),
          f('HYPHENRANGE', `^\\s*(${c[l.XRANGEPLAIN]})\\s+-\\s+(${c[l.XRANGEPLAIN]})\\s*$`),
          f('HYPHENRANGELOOSE', `^\\s*(${c[l.XRANGEPLAINLOOSE]})\\s+-\\s+(${c[l.XRANGEPLAINLOOSE]})\\s*$`),
          f('STAR', '(<|>)?=?\\s*\\*'),
          f('GTE0', '^\\s*>=\\s*0\\.0\\.0\\s*$'),
...
function to() {
  ...
  const t = /^[0-9]+$/,
    e = (n, i) => {
      if (typeof n == 'number' && typeof i == 'number') return n === i ? 0 : n < i ? -1 : 1;
      const o = t.test(n),
        a = t.test(i);
...
function oe() {
  ...
  jn = 1;
  const t = jt(),
    { MAX_LENGTH: e, MAX_SAFE_INTEGER: r } = Bt(),
    { safeRe: n, t: i } = ft(),
    o = vn(),
    { compareIdentifiers: a } = to();
  class d {
    constructor(s, l) {
      if (((l = o(l)), s instanceof d)) {
        if (s.loose === !!l.loose && s.includePrerelease === !!l.includePrerelease) return s;
        s = s.version;
      } else if (typeof s != 'string') throw new TypeError(`Invalid version. Must be a string. Got type "${typeof s}".`);
      if (s.length > e) throw new TypeError(`version is longer than ${e} characters`);
      ...
      if (!u) throw new TypeError(`Invalid Version: ${s}`);
      ...
      (u[4]
        ? (this.prerelease = u[4].split('.').map(h => {
            if (/^[0-9]+$/.test(h)) {
              const p = +h;
              if (p >= 0 && p < r) return p;
            }
    ...
    comparePre(s) {
      if ((s instanceof d || (s = new d(s, this.options)), this.prerelease.length && !s.prerelease.length)) return -1;
      if (!this.prerelease.length && s.prerelease.length) return 1;
      if (!this.prerelease.length && !s.prerelease.length) return 0;
      let l = 0;
      do {
        const u = this.prerelease[l],
          h = s.prerelease[l];
        if ((t('prerelease compare', l, u, h), u === void 0 && h === void 0)) return 0;
    ...
    compareBuild(s) {
      ...
      let l = 0;
      do {
        const u = this.build[l],
          h = s.build[l];
        if ((t('build compare', l, u, h), u === void 0 && h === void 0)) return 0;
        if (h === void 0) return 1;
        if (u === void 0) return -1;
        if (u === h) continue;
        return a(u, h);
    ...
    inc(s, l, u) {
      if (s.startsWith('pre')) {
        if (!l && u === !1) throw new Error('invalid increment argument: identifier is empty');
        if (l) {
          const h = `-${l}`.match(this.options.loose ? n[i.PRERELEASELOOSE] : n[i.PRERELEASE]);
          if (!h || h[1] !== l) throw new Error(`invalid identifier: ${l}`);
        }
      }
      switch (s) {
        case 'premajor':
        ...
        case 'pre': {
          ...
          if (this.prerelease.length === 0) this.prerelease = [h];
            ...
            if (p === -1) {
              if (l === this.prerelease.join('.') && u === !1) throw new Error('invalid increment argument: identifier already exists');
          ...
          if (l) {
            let p = [l, h];
            (u === !1 && (p = [l]),
              a(this.prerelease[0], l) === 0 ? isNaN(this.prerelease[1]) && (this.prerelease = p) : (this.prerelease = p));
          }
          break;
        }
        default:
...
function Na() {
  ...
  return (
    (pr = (r, n, i, o, a) => {
      ...
      try {
        return new t(r instanceof t ? r.version : r, i).inc(n, o, a).version;
      } catch {
        return null;
      }
    }),
  ...
  return (
    (mr = (r, n) => {
      ...
      if (!!s.prerelease.length && !l) {
        ...
        if (s.compareMain(c) === 0) return s.minor && !s.patch ? 'minor' : 'patch';
      }
      const h = l ? 'pre' : '';
...
function Ua() {
  ...
  return (
    (_r = (o, a) => {
      ...
      a = a || {};
      let d = null;
      if (!a.rtl) d = o.match(a.includePrerelease ? r[n.COERCEFULL] : r[n.COERCE]);
      else {
      ...
      const c = d[2],
        s = d[3] || '0',
        l = d[4] || '0',
        u = a.includePrerelease && d[5] ? `-${d[5]}` : '',
        h = a.includePrerelease && d[6] ? `+${d[6]}` : '';
...
function Ee() {
  ...
  class e {
    constructor(m, y) {
      if (((y = i(y)), m instanceof e)) return m.loose === !!y.loose && m.includePrerelease === !!y.includePrerelease ? m : new e(m.raw, y);
      if (m instanceof o) return ((this.raw = m.value), (this.set = [[m]]), (this.formatted = void 0), this);
      if (
        ((this.options = y),
        (this.loose = !!y.loose),
        (this.includePrerelease = !!y.includePrerelease),
        (this.raw = m.trim().replace(t, ' ')),
        (this.set = this.raw
          .split('||')
      ...
      if (this.set.length > 1) {
        const E = this.set[0];
        if (((this.set = this.set.filter(R => !f(R[0]))), this.set.length === 0)) this.set = [E];
    ...
    get range() {
      if (this.formatted === void 0) {
        ...
        for (let m = 0; m < this.set.length; m++) {
          m > 0 && (this.formatted += '||');
          const y = this.set[m];
          for (let E = 0; E < y.length; E++) (E > 0 && (this.formatted += ' '), (this.formatted += y[E].toString().trim()));
        }
      }
    ...
    parseRange(m) {
      const E = ((this.options.includePrerelease && p) | (this.options.loose && b)) + ':' + m,
        R = n.get(E);
      if (R) return R;
      const w = this.options.loose,
        O = w ? c[s.HYPHENRANGELOOSE] : c[s.HYPHENRANGE];
      ((m = m.replace(O, Ie(this.options.includePrerelease))),
        a('hyphen replace', m),
        (m = m.replace(c[s.COMPARATORTRIM], l)),
        a('comparator trim', m),
        (m = m.replace(c[s.TILDETRIM], u)),
        a('tilde trim', m),
        (m = m.replace(c[s.CARETTRIM], h)),
        a('caret trim', m));
      let F = m
        .split(' ')
        .map(W => k(W, this.options))
        .join(' ')
        .split(/\s+/)
        .map(W => he(W, this.options));
      (w && (F = F.filter(W => (a('loose invalid filter', W, this.options), !!W.match(c[s.COMPARATORLOOSE])))), a('range list', F));
      const P = /* @__PURE__ */ new Map(),
        B = F.map(W => new o(W, this.options));
      for (const W of B) {
        if (f(W)) return [W];
        P.set(W.value, W);
      }
    ...
    test(m) {
      ...
      for (let y = 0; y < this.set.length; y++) if (ce(this.set[y], m, this.options)) return !0;
      return !1;
    }
  }
  Mr = e;
  const r = Xa(),
    ...
    a = jt(),
    d = oe(),
    { safeRe: c, t: s, comparatorTrimReplace: l, tildeTrimReplace: u, caretTrimReplace: h } = ft(),
    { FLAG_INCLUDE_PRERELEASE: p, FLAG_LOOSE: b } = Bt(),
    f = v => v.value === '<0.0.0-0',
    I = v => v.value === '',
    _ = (v, m) => {
      let y = !0;
      const E = v.slice();
      let R = E.pop();
      for (; y && E.length; ) ((y = E.every(w => R.intersects(w, m))), (R = E.pop()));
      return y;
    },
    k = (v, m) => (
      (v = v.replace(c[s.BUILD], '')),
      a('comp', v, m),
      (v = N(v, m)),
      a('caret', v),
      (v = V(v, m)),
          ...
          A(R)
            ...
            : A(w)
              ...
              : A(O)
                ? (P = `>=${R}.${w}.0 <${R}.${+w + 1}.0-0`)
                : F
                  ? (a('replaceTilde pr', F), (P = `>=${R}.${w}.${O}-${F} <${R}.${+w + 1}.0-0`))
                  : (P = `>=${R}.${w}.${O} <${R}.${+w + 1}.0-0`),
          a('tilde return', P),
          P
        );
    ...
    q = (v, m) => {
      a('caret', v, m);
      const y = m.loose ? c[s.CARETLOOSE] : c[s.CARET],
        E = m.includePrerelease ? '-0' : '';
          ...
          B
            ...
            : R && Ke
              ? (re && (O = 0),
                (F = 0),
                R === '>'
                  ? ((R = '>='), re ? ((w = +w + 1), (O = 0), (F = 0)) : ((O = +O + 1), (F = 0)))
                  : R === '<=' && ((R = '<'), re ? (w = +w + 1) : (O = +O + 1)),
                R === '<' && (P = '-0'),
                (E = `${R + w}.${O}.${F}${P}`))
              : re
                ? (E = `>=${w}.0.0${P} <${+w + 1}.0.0-0`)
                : W && (E = `>=${w}.${O}.0${P} <${w}.${+O + 1}.0-0`),
          a('xRange return', E),
          E
        );
      });
    },
    Re = (v, m) => (a('replaceStars', v, m), v.trim().replace(c[s.STAR], '')),
    he = (v, m) => (a('replaceGTE0', v, m), v.trim().replace(c[m.includePrerelease ? s.GTE0PRE : s.GTE0], '')),
    Ie = v => (m, y, E, R, w, O, F, P, B, re, W, Ke) => (
      A(E)
        ? (y = '')
        : A(R)
          ? (y = `>=${E}.0.0${v ? '-0' : ''}`)
...
function Gt() {
  ...
  class e {
    ...
    parse(l) {
      const u = this.options.loose ? n[i.COMPARATORLOOSE] : n[i.COMPARATOR],
        h = l.match(u);
      if (!h) throw new TypeError(`Invalid comparator: ${l}`);
      ((this.operator = h[1] !== void 0 ? h[1] : ''),
        this.operator === '=' && (this.operator = ''),
        h[2] ? (this.semver = new d(h[2], this.options.loose)) : (this.semver = t));
    }
    toString() {
      return this.value;
    }
    test(l) {
      if ((a('Comparator.test', l, this.options.loose), this.semver === t || l === t)) return !0;
      if (typeof l == 'string')
        try {
    ...
    intersects(l, u) {
      ...
      return this.operator === ''
        ? this.value === ''
          ? !0
          : new c(l.value, u).test(this.value)
        : l.operator === ''
          ? l.value === ''
            ? !0
            : new c(this.value, u).test(l.semver)
          : ((u = r(u)),
            (u.includePrerelease && (this.value === '<0.0.0-0' || l.value === '<0.0.0-0')) ||
            (!u.includePrerelease && (this.value.startsWith('<0.0.0') || l.value.startsWith('<0.0.0')))
              ? !1
              : !!(
                  (this.operator.startsWith('>') && l.operator.startsWith('>')) ||
                  (this.operator.startsWith('<') && l.operator.startsWith('<')) ||
                  (this.semver.version === l.semver.version && this.operator.includes('=') && l.operator.includes('=')) ||
                  (o(this.semver, '<', l.semver, u) && this.operator.startsWith('>') && l.operator.startsWith('<')) ||
                  (o(this.semver, '>', l.semver, u) && this.operator.startsWith('<') && l.operator.startsWith('>'))
                ));
    }
  }
...
function Ja() {
  ...
  return (
    (qr = (i, o) => {
      i = new e(i, o);
      let a = new t('0.0.0');
      if (i.test(a) || ((a = new t('0.0.0-0')), i.test(a))) return a;
      a = null;
  ...
  return (
    (jr = (l, u, h, p) => {
      ...
      for (let A = 0; A < u.set.length; ++A) {
        ...
        if (
          (V.forEach(q => {
            (q.semver === r && (q = new e('>=0.0.0')),
              (G = G || q),
              (N = N || q),
              b(q.semver, G.semver, p) ? (G = q) : I(q.semver, N.semver, p) && (N = q));
          }),
          G.operator === _ || G.operator === k || ((!N.operator || N.operator === _) && f(l, N.semver)))
        )
          return !1;
        if (N.operator === k && I(l, N.semver)) return !1;
      }
      return !0;
    }),
    jr
...
function rs() {
  ...
  return (
    (Xr = (r, n, i) => {
      ...
      for (const h of c) t(h, n, i) ? ((d = h), a || (a = h)) : (d && o.push([a, d]), (d = null), (a = null));
      a && o.push([a, null]);
      const s = [];
      for (const [h, p] of o)
        h === p
          ...
          : !p && h === c[0]
            ...
            : p
              ...
              : s.push(`>=${h}`);
      const l = s.join(' || '),
        u = typeof n.raw == 'string' ? n.raw : String(n);
  ...
  const t = Ee(),
    ...
    c = (u, h, p) => {
      ...
      if (u.length === 1 && u[0].semver === r) {
        if (h.length === 1 && h[0].semver === r) return !0;
      ...
      let _;
      if (f && I) {
        if (((_ = i(f.semver, I.semver, p)), _ > 0)) return null;
        if (_ === 0 && (f.operator !== '>=' || I.operator !== '<=')) return null;
      }
      for (const T of b) {
        if ((f && !n(T, String(f), p)) || (I && !n(T, String(I), p))) return null;
        for (const J of h) if (!n(T, String(J), p)) return !1;
        return !0;
      }
      let k,
        A,
        V,
        G,
        N = I && !p.includePrerelease && I.semver.prerelease.length ? I.semver : !1,
        q = f && !p.includePrerelease && f.semver.prerelease.length ? f.semver : !1;
        ...
        if (((G = G || T.operator === '>' || T.operator === '>='), (V = V || T.operator === '<' || T.operator === '<='), f)) {
          if (
            (q &&
              ...
              T.semver.major === q.major &&
              T.semver.minor === q.minor &&
              T.semver.patch === q.patch &&
              (q = !1),
            T.operator === '>' || T.operator === '>=')
          ) {
            if (((k = s(f, T, p)), k === T && k !== f)) return !1;
          } else if (f.operator === '>=' && !n(f.semver, String(T), p)) return !1;
        }
        if (I) {
          if (
            (N &&
            ...
            if (((A = l(I, T, p)), A === T && A !== I)) return !1;
          } else if (I.operator === '<=' && !n(I.semver, String(T), p)) return !1;
        }
        if (!T.operator && (I || f) && _ !== 0) return !1;
      }
...
var os = is();
const lt = /* @__PURE__ */ So(os),
  Oi = t => lt.valid(t) ?? lt.valid(lt.coerce(t)),
  as = window.Vaadin.copilot.eventbus;
as.on('serverInfo', t => {
  const r = t.detail.versions.find(o => o.name === 'Vaadin');
  if (!r) return;
  const n = Fe.getMostRecentVaadinVersion(),
    i = r.version;
  Ai(`${$o}get-release-note-url`, { version: i }, o => {
    ...
    if (!a.error && a.url)
      if (n) {
        const d = Oi(i),
          c = Oi(n),
          s = d !== null && c !== null ? lt.gte(d, c) : i === n;
        (D.setProjectVersionReleaseNoteInfo({
          ...
          d !== null &&
            ...
            (Pe({
              ...
              details: Ht(C`<a class="ahreflike" href="${a.url}" target="_blank">Click here to open release notes!</a>`),
            }),
            Fe.setMostRecentReleaseNoteDismissed(!1),
            Fe.setMostRecentVaadinVersion(i)));
      } else
        (Fe.setMostRecentReleaseNoteDismissed(!1),
          Fe.setMostRecentVaadinVersion(i),
          D.setProjectVersionReleaseNoteInfo({
