...
var A = Object.defineProperty,
  ...
  o = (e, t, n, l) => {
    for (var a = l > 1 ? void 0 : l ? P(t, n) : t, p = e.length - 1, r; p >= 0; p--) (r = e[p]) && (a = (l ? r(t, n, a) : r(a)) || a);
    return (l && a && A(t, n, a), a);
  };
const F = 'https://github.com/vaadin',
  u = 'https://github.com/vaadin/copilot/issues/new',
  T = '?template=feature_request.md&title=%5BFEATURE%5D',
  D = 'A short, concise description of the bug and why you consider it a bug. Any details like exceptions and logs can be helpful as well.',
  E =
    'Please provide as many details as possible, this will help us deliver a fix as soon as possible.%0AThank you!%0A%0A%23%23%23 Description of the Bug%0A%0A{description}%0A%0A%23%23%23 Expected Behavior%0A%0AA description of what you would expect to happen. (Sometimes it is clear what the expected outcome is if something does not work, other times, it is not super clear.)%0A%0A%23%23%23 Minimal Reproducible Example%0A%0AWe would appreciate the minimum code with which we can reproduce the issue.%0A%0A%23%23%23 Versions%0A{versionsInfo}';
let i = class extends w {
  ...
  submit() {
    if ((h('feedback', { github: !1, type: this.type, topic: this.topic }), this.description.trim() === '')) {
      ((this.descriptionField.invalid = !0),
        (this.descriptionField.placeholder = 'Please tell us more before sending'),
    ...
    (d.emit('system-info-with-callback', {
      ...
      this.parentNode?.style.setProperty('--section-height', '150px'),
      (this.message = 'Thank you for sharing feedback.'));
  }
  keyDown(e) {
  ...
  openGithub(e, t) {
    ...
    const n = e ? e.replace(/\n/g, '%0A') : 'Activate Copilot to include version info.',
      l = `${t.types.find(r => r.value === this.type)?.ghTitle}`,
      a = t.description !== '' ? t.description : D,
      p = E.replace('{description}', a).replace('{versionsInfo}', n);
    window.open(`${u}?title=${l}&body=${p}`, '_blank')?.focus();
  }
};
o([s()], i.prototype, 'description', 2);
o([s()], i.prototype, 'type', 2);
o([s()], i.prototype, 'topic', 2);
o([s()], i.prototype, 'email', 2);
o([s()], i.prototype, 'message', 2);
o([s()], i.prototype, 'types', 2);
o([s()], i.prototype, 'topics', 2);
o([g('vaadin-text-area')], i.prototype, 'descriptionField', 2);
i = o([k('copilot-feedback-panel')], i);
const b = {
...
v.addPanel(b);
export { i as CopilotFeedbackPanel };
