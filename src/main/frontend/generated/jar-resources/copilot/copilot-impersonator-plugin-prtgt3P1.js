      ...
      (this.handleSwitchUser = async () => {
        if (!(!this.username || this.isLoading)) {
          ...
          try {
            ...
            e.success
              ? (o.addRecentSwitchedUsername(this.username), window.location.reload())
              : ((this.errorMessage = e.errorMessage), (this.isLoading = !1));
          } catch {
...
l([m()], a.prototype, 'username', 2);
l([m()], a.prototype, 'errorMessage', 2);
l([m()], a.prototype, 'isLoading', 2);
a = l([x('copilot-impersonator')], a);
const h = {
...
f.addPanel(h);
export { a as CopilotImpersonatorPanel };
